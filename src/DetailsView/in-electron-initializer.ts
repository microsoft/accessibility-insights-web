...
adapter.getTab(
    ...
    (tab: Tab): void => {
        ...
        const visualizationStore = new StoreProxy<VisualizationStoreData>(StoreNames[StoreNames.VisualizationStore], adapter);
        const tabStore = new StoreProxy<TabStoreData>(StoreNames[StoreNames.TabStore], adapter);
        ...
        const detailsViewStore = new StoreProxy<DetailsViewData>(StoreNames[StoreNames.DetailsViewStore], adapter);
        const assessmentStore = new StoreProxy<AssessmentStoreData>(StoreNames[StoreNames.AssessmentStore], adapter);
        const featureFlagStore = new StoreProxy<DictionaryStringTo<boolean>>(StoreNames[StoreNames.FeatureFlagStore], adapter);
        const scopingStore = new StoreProxy<ScopingStoreData>(StoreNames[StoreNames.ScopingPanelStateStore], adapter);
        const inspectStore = new StoreProxy<InspectStoreData>(StoreNames[StoreNames.InspectStore], adapter);
        const userConfigStore = new StoreProxy<UserConfigurationStoreData>(StoreNames[StoreNames.UserConfigurationStore], adapter);
        ...
        const actionMessageDispatcher = new ActionMessageDispatcher(adapter.sendMessageToFrames, tab.id);
