...
export const FailureInstancePanelDetails = NamedFC<
    FailureInstancePanelDetailsProps
>('FailureInstancePanelDetails', props => {
    const getSnippetInfo = (): JSX.Element => {
        if (!props.snippet) {
            return (
                <div className={failureInstanceSnippetEmptyBody}>
                    Code snippet will auto-populate based on the CSS selector
                    input.
                </div>
            );
            ...
            return (
                <div className={failureInstanceSnippetFilledBody}>
                    {props.snippet}
                </div>
            );
        }
    ...
    return (
        <div>
            ...
            <div className={failureInstanceSelectorNote}>
                Note: If the CSS selector maps to multiple snippets, the first
                will be selected
            </div>
            <div>
                <DefaultButton
