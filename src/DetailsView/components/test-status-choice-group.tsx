...
import {
    ...
    undoButton,
    undoButtonIcon,
} from './test-status-choice-group.scss';
...
> {
    ...
    public componentDidUpdate(
        prevProps: Readonly<TestStatusChoiceGroupProps>,
    ): void {
    ...
    protected onUndoClicked = (): void => {
        this.setState({
            selectedKey: ManualTestStatus[ManualTestStatus.UNKNOWN],
        });
        this.choiceGroup.focus();
        this.props.onUndoClicked(
            this.props.test,
            this.props.step,
            this.props.selector,
        );
