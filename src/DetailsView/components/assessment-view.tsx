...
export type WithAssessmentTestResult = {
...
export class AssessmentView extends React.Component<AssessmentViewProps> {
        ...
        return (
            <div className="assessment-content">
                ...
                {this.renderGettingStarted(
                    assessmentTestResult.definition.gettingStarted,
                )}
    ...
    public componentDidUpdate(prevProps: AssessmentViewProps): void {
        if (this.isStepSwitched(prevProps)) {
            this.disableVisualHelpersForTest(
                prevProps.assessmentNavState.selectedTestType,
            );
            this.enableSelectedStepVisualHelper();
        } else {
    ...
    private enableSelectedStepVisualHelper(sendTelemetry = true): void {
        ...
        if (
            this.visualHelperDisabledByDefault(test, step) ||
            this.isTargetChanged()
        ) {
            return;
        }

        const isStepNotScanned = !this.props.assessmentData.testStepStatus[step]
            .isStepScanned;
    ...
    private visualHelperDisabledByDefault(
        ...
        return (
            this.props.deps.assessmentsProvider.getStep(test, step)
    ...
    private disableVisualHelpersForTest(test: VisualizationType): void {
        this.props.deps.detailsViewActionMessageCreator.disableVisualHelpersForTest(
            test,
        );
    }
    ...
    private renderGettingStarted(gettingStarted: JSX.Element): JSX.Element {
        return (
            <CollapsibleComponent
                header={
                    <h2 className="assessment-getting-started-title">
                        Getting Started
                    </h2>
                }
            ...
            <div className="details-view-assessment-content">
                ...
                <div className="test-step-view-container">
                    <TestStepView
                        ...
                        renderStaticContent={
                            selectedRequirement.definition.renderStaticContent
                        }
                        instancesMap={
                            this.props.assessmentData
                        ...
                        assessmentsProvider={
                            this.props.deps.assessmentsProvider
                        }
