...
export class AssessmentActionCreator {
    ...
    private onContinuePreviousAssessment = (
    ...
    private onChangeAssessmentVisualizationState = (
        ...
        this.telemetryEventHandler.publishTelemetry(eventName, payload);
        this.assessmentActions.changeAssessmentVisualizationState.invoke(
            payload,
        );
    };

    private onChangeVisualizationStateForAll = (
        payload: ChangeInstanceSelectionPayload,
    ): void => {
        const eventName =
            TelemetryEvents.CHANGE_ASSESSMENT_VISUALIZATION_STATUS_FOR_ALL;
        this.telemetryEventHandler.publishTelemetry(eventName, payload);
        this.assessmentActions.changeAssessmentVisualizationStateForAll.invoke(
            payload,
        );
    };
    ...
    private onTrackingCompleted = (payload: ScanBasePayload): void => {
        const telemetryEventName =
            'TrackingCompleted' + capitalize(payload.key);
        this.telemetryEventHandler.publishTelemetry(
            telemetryEventName,
            payload,
        );
