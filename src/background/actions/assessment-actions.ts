...
export class AssessmentActions {
    ...
    public readonly changeInstanceStatus = new Action<
        ChangeInstanceStatusPayload
    >();
    public readonly changeRequirementStatus = new Action<
        ChangeRequirementStatusPayload
    >();
    public readonly addFailureInstance = new Action<
        AddFailureInstancePayload
    >();
    public readonly addResultDescription = new Action<
        AddResultDescriptionPayload
    >();
    public readonly removeFailureInstance = new Action<
        RemoveFailureInstancePayload
    >();
    public readonly editFailureInstance = new Action<
        EditFailureInstancePayload
    >();
    ...
    public readonly changeAssessmentVisualizationStateForAll = new Action<
        ChangeInstanceSelectionPayload
    >();
    public readonly undoInstanceStatusChange = new Action<
        AssessmentActionInstancePayload
    >();
    public readonly undoRequirementStatusChange = new Action<
        ChangeRequirementStatusPayload
    >();
    ...
    public readonly updateSelectedPivotChild = new Action<
        UpdateSelectedDetailsViewPayload
    >();
