    ...
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0)">
            ...
            <mask id="mask1" mask-type="alpha" maskUnits="userSpaceOnUse" x="-6" y="-3" width="30" height="31">
                <path d="M23.9718 7.27863L4.11284 27.1376C-1.37106 21.6537 -1.37106 12.7625 4.11284 7.27863C9.59675 1.79472 18.4879 1.79472 23.9718 7.27863Z" fill="#CFEBFF" />
                <path d="M23.9718 7.27863L4.11284 27.1376C-1.37106 21.6537 -1.37106 12.7625 4.11284 7.27863C9.59675 1.79472 18.4879 1.79472 23.9718 7.27863Z" fill="url(#paint0_linear)" />
            </mask>
            <g mask="url(#mask1)">
                <path d="M23.9718 7.27863L4.11284 27.1376C-1.37106 21.6537 -1.37106 12.7625 4.11284 7.27863C9.59675 1.79472 18.4879 1.79472 23.9718 7.27863Z" fill="white" />
                <path d="M23.9718 7.27863L4.11284 27.1376C-1.37106 21.6537 -1.37106 12.7625 4.11284 7.27863C9.59675 1.79472 18.4879 1.79472 23.9718 7.27863Z" fill="url(#paint1_linear)" />
                <rect x="4.54834" y="6.88206" width="16.3577" height="42.2726" transform="rotate(-45 4.54834 6.88206)" fill="#D6E9F7" />
        ...
        <defs>
            <filter id="filter0_d" x="15.748" y="6.50654" width="29.5246" height="29.5269" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                ...
                <feColorMatrix type="matrix" values="0 0 0 0 0.0447352 0 0 0 0 0.305769 0 0 0 0 0.492222 0 0 0 0.51 0" />
