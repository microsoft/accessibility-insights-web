...
describe('VisualizationInstanceProcessorTest', () => {
    test('nullProcessor', () => {
        ...
        expect(
            VisualizationInstanceProcessor.nullProcessor(instancesStub),
        ).toMatchObject(instancesStub);
    });

    test('addOrder', () => {
        const initialInstances: VisualizationPropertyBag<
            PartialTabOrderPropertyBag
        >[] = [
            {
        ...
        const expectedInstances: VisualizationPropertyBag<
            TabOrderPropertyBag
        >[] = [
            {
                ...createNullifiedAssessmenVisualizationInstance(),
        ...
        const actual = VisualizationInstanceProcessor.addOrder(
            initialInstances,
        );
