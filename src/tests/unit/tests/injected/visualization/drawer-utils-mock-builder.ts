...
export class DrawerUtilsMockBuilder {
        ...
        this.drawerUtilsMock
            ...
            .returns(
                (
                    offset,
                    doc,
                    elementBoundingClientRectHeight,
                    bodyStyle,
                    docStyle,
                ) => sizeValue,
            );
    ...
    public setupGetDocSize(sizeValue: number): DrawerUtilsMockBuilder {
        this.drawerUtilsMock
            .setup(d =>
                d.getDocumentHeight(It.isAny(), this.styleStub, this.styleStub),
            )
            .returns(
                (
                    offset,
        ...
        this.drawerUtilsMock
            .setup(d =>
                d.getDocumentWidth(It.isAny(), this.styleStub, this.styleStub),
            )
            .returns(
                (
                    offset,
    ...
    public setupGetContainerOffset(
        offsetValue: number,
    ): DrawerUtilsMockBuilder {
        this.drawerUtilsMock
            .setup(d => d.getContainerTopOffset(It.isAny()))
            .returns(() => offsetValue);
        this.drawerUtilsMock
    ...
    public setupIsOutsideOfDocument(
        isOutside: boolean,
    ): DrawerUtilsMockBuilder {
