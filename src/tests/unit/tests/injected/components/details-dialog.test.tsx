...
describe('DetailsDialog', () => {
    ...
    describe('renders', () => {
        ...
        test.each(testCases)('with: %p', (testCase: DetailsDialogTestCase) => {
            ...
            const dialogDetailsHandlerMockObject = getDetailsDialogHandlerStub(
                isDevToolsOpen,
            );
    ...
    describe('handlers', () => {
        describe('for CommandBar', () => {
            ...
            beforeEach(() => {
                ...
                dialogDetailsHandlerMockObject = getDetailsDialogHandlerStub(
                    true,
                );
            });
            ...
            test.each(shadowDialogEnabled)(
                ...
                shadowDialog => {
                    ...
                    const wrapper = shallow<DetailsDialog>(
                        <DetailsDialog {...props} />,
                    );
            ...
            test.each(shadowDialogEnabled)(
                ...
                shadowDialog => {
                    const handlerMock = Mock.ofInstance<
                        (component: DetailsDialog) => boolean
                    ...
                    handlerMock.verify(
                        handler => handler(wrapper.instance()),
                        Times.once(),
                    );
                },
            );
