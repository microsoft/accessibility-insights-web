...
describe('LiveAndroidSetupDeps', () => {
    ...
    it('hasExpectedServiceVersion returns false on error', async () => {
        businessLogicMock
            .setup(m => m.hasRequiredServiceVersion(serviceConfigMock.object, undefined))
    ...
    it('hasExpectedServiceVersion returns false if business logic return false', async () => {
        businessLogicMock
            .setup(m => m.hasRequiredServiceVersion(serviceConfigMock.object, undefined))
