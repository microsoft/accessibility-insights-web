...
describe('DiagnosticViewToggleTest', () => {
    ...
    describe('user interaction: ', () => {
        ...
        it('handles command not found', () => {
            ...
            expect(renderAction).toThrowError(
                `Cannot find command for name: ${commandName}`,
            );
        });
    });
    ...
    describe('lifecycle events', () => {
        it('sets focus when componentDidMount', () => {
            ...
            const toggle = wrapper.find(VisualizationToggle).props()
    ...
    it('addUserEventListener', () => {
        ...
        const addUserEventListenerFunction = (testObject as any)
    ...
    function createDepsMock(): IMock<ContentLinkDeps> {
        ...
        depsMock
            .setup(deps => deps.contentProvider)
            .returns(() => contentProviderMock.object);
...
class DiagnosticViewTogglePropsBuilder {
    ...
    public setupToggleVisualizationCall(
        event,
    ): DiagnosticViewTogglePropsBuilder {
        this.clickHandlerMock
            .setup(ch =>
                ch.toggleVisualization(
                    this.data,
                    this.visualizationType,
                    event,
                ),
