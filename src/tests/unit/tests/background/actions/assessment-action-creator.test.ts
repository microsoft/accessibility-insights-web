...
describe('AssessmentActionCreatorTest', () => {
    ...
    beforeEach(() => {
        assessmentActionsMock = Mock.ofType(
            AssessmentActions,
            MockBehavior.Strict,
        );
    ...
    it('handles PassUnmarkedInstances message', () => {
        ...
        const passUnmarkedInstanceActionMock = createActionMock(
            telemetryOnlyPayload,
        );

        setupAssessmentActionsMock('updateTargetTabId', updateTabIdActionMock);
        setupAssessmentActionsMock(
            'passUnmarkedInstance',
            passUnmarkedInstanceActionMock,
        );
    ...
    it('handles EditFailureInstance message', () => {
        ...
        telemetryEventHandlerMock.verify(
            tp =>
                tp.publishTelemetry(
                    TelemetryEvents.EDIT_FAILURE_INSTANCE,
                    payload,
                ),
            Times.once(),
        );
    ...
    it('handles RemoveFailureInstance message', () => {
        ...
        telemetryEventHandlerMock.verify(
            tp =>
                tp.publishTelemetry(
                    TelemetryEvents.REMOVE_FAILURE_INSTANCE,
                    payload,
                ),
            Times.once(),
        );
    ...
    it('handles AddFailureInstance message', () => {
        ...
        telemetryEventHandlerMock.verify(
            handler =>
                handler.publishTelemetry(
                    TelemetryEvents.ADD_FAILURE_INSTANCE,
                    payload,
                ),
            Times.once(),
        );
    ...
    it('handles ChangeManualRequirementStatus message', () => {
        ...
        telemetryEventHandlerMock.verify(
            handler =>
                handler.publishTelemetry(
                    TelemetryEvents.CHANGE_INSTANCE_STATUS,
                    payload,
                ),
            Times.once(),
        );
    ...
    it('handles UndoChangeManualRequirementStatus message', () => {
        ...
        telemetryEventHandlerMock.verify(
            handler =>
                handler.publishTelemetry(
                    TelemetryEvents.UNDO_REQUIREMENT_STATUS_CHANGE,
                    payload,
                ),
            Times.once(),
        );
    ...
    it('handles UndoAssessmentInstanceStatusChange message', () => {
        ...
        telemetryEventHandlerMock.verify(
            handler =>
                handler.publishTelemetry(
                    TelemetryEvents.UNDO_TEST_STATUS_CHANGE,
                    payload,
                ),
            Times.once(),
        );
    ...
    it('handles ChangeAssessmentVisualizationState message', () => {
        ...
        const changeAssessmentVisualizationStateMock = createActionMock(
            payload,
        );
        const actionsMock = createActionsMock(
    ...
    it('handles ChangeVisualizationStateForAll message', () => {
        ...
        const changeAssessmentVisualizationStateForAllMock = createActionMock(
            payload,
        );
        const actionsMock = createActionsMock(
    ...
    it('handles SelectTestRequirement message', () => {
        ...
        telemetryEventHandlerMock.verify(
            tp =>
                tp.publishTelemetry(
                    TelemetryEvents.SELECT_REQUIREMENT,
                    payload,
                ),
            Times.once(),
        );
    ...
    it('handles TrackingCompleted message', () => {
        ...
        telemetryEventHandlerMock.verify(
            handler =>
                handler.publishTelemetry('TrackingCompletedHello', payload),
            Times.once(),
        );
    });
