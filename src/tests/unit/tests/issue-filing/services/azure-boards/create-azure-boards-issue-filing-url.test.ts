    ...
    describe('creates url', () => {
        it('uses description field, without tags', () => {
            ...
            queryBuilderMock
                .setup(builder =>
                    builder.withBaseUrl(
                        `${settingsData.projectURL}/_workitems/create/Issue`,
                    ),
                )
                .returns(() => queryBuilderMock.object);
            queryBuilderMock
            ...
            queryBuilderMock
                .setup(builder =>
                    builder.withParam('[System.Description]', testIssueDetails),
                )
                .returns(() => queryBuilderMock.object);
        ...
        it('uses description field, with tags', () => {
            ...
            queryBuilderMock
                .setup(builder =>
                    builder.withParam('[System.Tags]', expectedTags),
                )
                .returns(() => queryBuilderMock.object);
            queryBuilderMock
                .setup(builder =>
        ...
        it('uses repro steps field, without tags', () => {
            ...
            queryBuilderMock
                .setup(builder =>
                    builder.withBaseUrl(
                        `${settingsData.projectURL}/_workitems/create/Bug`,
                    ),
                )
                .returns(() => queryBuilderMock.object);
