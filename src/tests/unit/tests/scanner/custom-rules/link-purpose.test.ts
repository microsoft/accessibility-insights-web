...
describe('link purpose', () => {
    describe('verify link purpose configs', () => {
        it('should have correct props', () => {
            ...
            expect(linkPurposeConfiguration.rule.none[0]).toBe(
                'has-widget-role',
            );
            expect(linkPurposeConfiguration.rule.all[0]).toBe(
            ...
            expect(linkPurposeConfiguration.checks[1].id).toBe(
                'valid-role-if-present',
            );
        });
    });
