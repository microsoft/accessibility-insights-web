...
} from '../../../../../DetailsView/components/preview-features-panel';
import { PreviewFeatureFlagsHandler } from '../../../../../DetailsView/handlers/preview-feature-flags-handler';

describe('PreviewFeaturesPanelTest', () => {
    test('constructor', () => {
        const testSubject = new PreviewFeaturesPanel(
            {} as PreviewFeaturesPanelProps,
        );
    ...
    test('render', () => {
        ...
        const previewFeatureFlagsHandler = Mock.ofType(
        ...
        const expected = (
            <GenericPanel
                ...
                onDismiss={
                    testProps.actionMessageCreator.closePreviewFeaturesPanel
                }
            ...
            >
                <PreviewFeaturesContainer
                    ...
                    previewFeatureFlagsHandler={
                        testProps.previewFeatureFlagsHandler
                    }
                />
            </GenericPanel>
        );
