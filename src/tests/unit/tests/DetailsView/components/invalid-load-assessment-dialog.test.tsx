...
import { InvalidLoadAssessmentDialog, InvalidLoadAssessmentDialogProps } from 'DetailsView/components/invalid-load-assessment-dialog';
...
describe('InvalidLoadAssessmentDialog', () => {
    ...
    it('should show when isOpen is set to true', () => {
        const renderResult = render(<InvalidLoadAssessmentDialog {...invalidLoadAssessmentDialogProps} />);
