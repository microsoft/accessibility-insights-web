...
describe('NavigatorUtilsTest', () => {
    test('getEnvironmentInfo: chrome', () => {
        validateBrowserSpecReturnedWithUserAgent(`Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36`, 'Chrome version 65.0.3325.181');
    });
