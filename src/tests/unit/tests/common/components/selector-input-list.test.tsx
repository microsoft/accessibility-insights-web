...
describe('SelectorInputListTest', () => {
    ...
    test('componentDidUpdate updates state when props have changed', () => {
        ...
        const result = Enzyme.shallow(<TestableSelectorInputList {...props} />);
        const firstState = (result.instance() as TestableSelectorInputList).state.isTextFieldValueValid;
        ...
        const secondState = (result.instance() as TestableSelectorInputList).state.isTextFieldValueValid;
    ...
    function genericButtonStateTests(result: Enzyme.ShallowWrapper<any, any>, givenSelector: string, expectedStateValue: boolean): void {
        (result.instance() as TestableSelectorInputList).setTextFieldValue(givenSelector);
    ...
    function genericDeleteSelectorTests(
        ...
        const createdRow = Enzyme.shallow(itemList.getElement().props.onRenderCell(itemList.getElement().props.items[0]));
