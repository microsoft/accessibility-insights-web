...
describe('getAssessmentSummaryModel', () => {
    ...
    const singleRequirementAll: IAssessmentSubsetForSummary[] = [
        sampleTests.test1,
    ];
    ...
    const singleRequirementStatusData: AssessmentStatusData = {
        [sampleTests.test1.key]:
            sampleResults[sampleTests.test1.key].storeData.testStepStatus,
    } as any;
    const singleRequirementStoreData: AssessmentStoreData = {
        assessments: {
            [sampleTests.test1.key]:
                sampleResults[sampleTests.test1.key].storeData,
        },
    } as any;
    ...
    const multipleRequirementsStatusData: AssessmentStatusData = {
        [sampleTests.test1.key]:
            sampleResults[sampleTests.test1.key].storeData.testStepStatus,
        [sampleTests.test2.key]:
            sampleResults[sampleTests.test2.key].storeData.testStepStatus,
    } as any;
    const multipleRequirementsStoreData: AssessmentStoreData = {
        assessments: {
            [sampleTests.test1.key]:
                sampleResults[sampleTests.test1.key].storeData,
            [sampleTests.test2.key]:
                sampleResults[sampleTests.test2.key].storeData,
        },
    } as any;
    ...
    describe('getAssessmentSummaryModelFromResults', () => {
        it('handles zero requirements', () => {
            const actual = getAssessmentSummaryModelFromResults(
                zeroRequirementsResults,
            );
