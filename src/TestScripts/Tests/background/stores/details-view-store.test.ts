...
describe('DetailsViewStoreTest', () => {
    ...
    test('onOpenPreviewFeatures', () => {
        ...
        createStoreTesterForPreviewFeatureActions('openPreviewFeatures')
            .testListenerToBeCalledOnce(initialState, expectedState);
    });
    ...
    test('onClosePreviewFeatures', () => {
        ...
        createStoreTesterForPreviewFeatureActions('closePreviewFeatures')
            .testListenerToBeCalledOnce(initialState, expectedState);
    });

    test('onOpenScoping', () => {
        const initialState = new DetailsViewStoreDataBuilder()
            .withScopingOpen(false)
            .build();

        const expectedState = new DetailsViewStoreDataBuilder()
            .withScopingOpen(true)
            .build();

        createStoreTesterForScopingActions('openScopingPanel')
            .testListenerToBeCalledOnce(initialState, expectedState);
    });
    ...
    test('onCloseScoping', () => {
        ...
        createStoreTesterForScopingActions('closeScopingPanel')
            .testListenerToBeCalledOnce(initialState, expectedState);
    });
    ...
    test('onOpenSettings', () => {
        ...
        const expectedState = new DetailsViewStoreDataBuilder()
            .withSettingPanelState(true)
            .build();

        createStoreTesterForDetailsViewActions('openSettingsPanel')
            .testListenerToBeCalledOnce(initialState, expectedState);
    });
    ...
    test('onCloseSettings', () => {
        ...
        createStoreTesterForDetailsViewActions('closeSettingsPanel')
            .testListenerToBeCalledOnce(initialState, expectedState);
    });
    ...
    test('onCloseContent', () => {
        ...
        createStoreTesterForContentActions('closeContentPanel')
            .testListenerToBeCalledOnce(initialState, expectedState);
    });

    function createStoreTesterForPreviewFeatureActions(actionName: keyof PreviewFeaturesActions) {
    ...
    function createStoreTesterForScopingActions(actionName: keyof ScopingActions) {
    ...
    function createStoreTesterForContentActions(actionName: keyof ContentActions) {
    ...
    function createStoreTesterForDetailsViewActions(actionName: keyof DetailsViewActions) {
