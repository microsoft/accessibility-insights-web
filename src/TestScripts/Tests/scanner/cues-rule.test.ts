...
import { GlobalMock, GlobalScope, Mock, MockBehavior, Times, It } from 'typemoq';
import * as AxeUtils from '../../../scanner/axe-utils';
import { evaluateCues, cuesConfiguration } from '../../../scanner/cues-rule';
import { testNativeWidgetConfiguration, createNodeStub } from './helpers';
