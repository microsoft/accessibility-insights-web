...
import { PopupView, PopupViewControllerDeps, PopupViewWithStoreSubscription } from '../../../../popup/scripts/components/popup-view';
...
import { title, subtitle } from '../../../../content/strings/application';
