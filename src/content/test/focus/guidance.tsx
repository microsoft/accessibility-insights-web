...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            When interacting with a website or web app using a keyboard (with or without assistive technology), users need to know which
            component currently has the input focus. By default, web browsers indicate focus visually, but custom programming, styles, style
            sheets, and scripting can disrupt it.
        </p>
        <p>
            ...
            its meaning and allows them to perform all supported functions. By default, focus order follows the DOM order, but tabindex
            attributes and scripting can be added to modify the focus order.
        </p>

        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Provide a visible focus indicator on the interactive element that has the input focus. (<Link.WCAG_2_4_7 />)
                </h3>
                <ul>
                    <li>
                        Input focus is commonly indicated by a solid or dotted border surrounding the element, but other visible changes are
                        acceptable.
                    </li>
                </ul>
                <h3>
                    Ensure interactive components receive focus in a logical, usable order. (<Link.WCAG_2_4_3 />)
                </h3>
                <ul>
                    <li>
                        Typically, keyboard users should encounter interactive components in the same order you would expect for mouse
                        users.
                    </li>
                </ul>
                <h3>
                    When previously hidden content is revealed, move focus into the revealed content. (<Link.WCAG_2_4_3 />)
                </h3>
                <ul>
                ...
                <h3>
                    Handle focus correctly when revealed content is again hidden. (<Link.WCAG_2_4_3 />)
                </h3>
                <ul>
            ...
            <Markup.Dont>
                <h3>
                    Don’t assume focus order must strictly follow a left-to-right / top-to-bottom reading order. (<Link.WCAG_2_4_3 />)
                </h3>
                <ul>
                    <li>
                        for example, if you expect mouse users to work down through one column of content before moving to the next column,
                        make sure the focus order follows that path.
                    </li>
                </ul>
            </Markup.Dont>
        </Markup.Columns>
