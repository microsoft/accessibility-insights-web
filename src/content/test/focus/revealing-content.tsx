...
export const infoAndExamples = create(({ Markup }) => <>
    ...
    <Markup.PassFail
        failText={
            <p>A button is scripted to open a modal dialog. Focus doesn't move automatically into the dialog, and neither does tabbing once.</p>
        }

        passText={
            <p>Additional scripting moves focus into the dialog as soon as it's opened.</p>
        }
    />
