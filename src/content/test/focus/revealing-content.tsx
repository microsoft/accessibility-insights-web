...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                When a keyboard user activates a control (such as a button) that reveals previously hidden content (such as a menu or
                dialog), they must be able to navigate quickly and easily into the revealed content.
            </p>

            <h2>How to fix</h2>
            <p>
                When the user reveals hidden content, move input focus into the revealed content. In most cases, focus should move to the
                first focusable element in the dialog.
            </p>
            ...
            <ul>
                <li>
                    ...
                    <Markup.Code>tabindex="-1"</Markup.Code> to a static element at the top of the dialog (such as the dialog's title) and
                    use scripting to move focus to that element.
                </li>
                <li>
                ...
                <li>
                    If a dialog is intended to allow users to review their own input before committing to an action, consider setting focus
                    on the dialog's commit button (such as 'Save' or 'Delete').
                </li>
            </ul>
            <h2>Example</h2>
            <Markup.PassFail
                failText={
                    <p>
                        A button is scripted to open a modal dialog. Focus doesn't move automatically into the dialog, and neither does
                        tabbing once.
                    </p>
                }
