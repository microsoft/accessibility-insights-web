...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                The purpose of a modal dialog is to constrain user input (temporarily) to controls within the dialog. Just as mouse users
                should not be able to click elements outside the dialog, keyboard users should not be able to Tab to elements outside the
                dialog.
            </p>
            ...
            <ul>
                <li>
                    If a modal dialog contains a single focusable element (such as an 'OK' button), simply prevent any behavior from
                    occurring when the user presses the Tab key.
                </li>
                <li>
            ...
            <Markup.PassFail
                ...
                passText={
                    <div>
                        ...
                        <p>
                            When the user Tabs <Markup.Emphasis>backward</Markup.Emphasis> from the first focusable element, scripting moves
                            it to the <Markup.Emphasis>last</Markup.Emphasis> focusable element.
                        </p>
                    </div>
                }
            />
