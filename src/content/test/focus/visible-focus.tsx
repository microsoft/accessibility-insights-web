...
export const infoAndExamples = create(({ Markup }) => (
    <>
        <h1>Visible focus</h1>
        <p>
            Components must provide a visible indication when they have the
            input focus.
        </p>

        <h2>Why it matters</h2>
        <p>
            Keyboard users need to know which component currently has the input
            focus so they can predict the results of their key presses. By
            default, web browsers indicate focus visually, but custom
            programming, styling, and scripting can disrupt it.
        </p>
        <h3>From a user's perspective</h3>
        <p>
            <Markup.Emphasis>
                "Having used your solution for some time, I have advanced in my
                skills to the point where using keyboard navigation and commands
                is faster than pointing and clicking. Help me focus and keep
                track of where I am at with visual cues, such as a focus ring,
                bolding text for labels that are in focus, etc."
            </Markup.Emphasis>
        </p>
        ...
        <ul>
            <li>
                If styling hides the focus indicator, remove the styling so the
                browser's default focus indicator is visible.
            </li>
            <li>
                If styling makes the focus indicator difficult to see, modify
                the styling so the focus rectangle has a contrast ratio at least
                as high as the default browser focus indicator.
            </li>
            <li>
                If scripting removes focus from an element after it is received,
                modify the script so the element retains focus until the user
                moves it.
            </li>
        </ul>
