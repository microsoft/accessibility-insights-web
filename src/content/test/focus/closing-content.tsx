...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                When a keyboard user dismisses revealed content (such as closing a menu or dialog), they expect focus to return to the
                trigger control that launched the content. Otherwise, they will have to explore the page content to re-orient themselves.
            </p>

            <h2>How to fix</h2>
            <ul>
                <li>
                    Good: Ensure that the revealed content appears in the DOM immediately after the trigger component. When the user closes
                    the revealed content, no element will have focus, but pressing Shift+Tab will move focus back to the trigger component.
                </li>
                <li>
                    Better: When the user dismisses revealed content, move focus to the original trigger component. This is the ideal
                    experience when the user cancels a dialog (dismisses it without taking any action).
                </li>
                <li>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        A calendar application includes a toolbar with buttons for creating, deleting, and editing appointments. Selecting
                        the "New appointment" button in the toolbar opens an "Appointment details" dialog. Closing the dialog moves focus to
                        the next item in the focus order, which happens to be the "Delete appointment" button.
                    </p>
                }
                passText={
                    <p>
                        When the dialog closes, focus placement depends on the expected workflow. If the user creates a new appointment,
                        focus moves to the 'Edit appointment' button in the toolbar. If they cancel without creating an appointment, focus
                        returns to the trigger element (the "New appointment" button).
                    </p>
                }
            />
