...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            Because people with motor, visual, or cognitive disabilities are more likely to inadvertently initiate mouse or touch events,
            they need a way to cancel or undo the consequences. Multipoint gestures (such as pinch-to-zoom) and path-based gestures (such as
            swiping) can be difficult or impossible to execute for people who have limited fine motor control or who use head tracking, gaze
            tracking, or speech commands to control their mouse pointer. People can't use motion operation (such shake-to-undo) if they use
            a mounted device, they are unable to perform the triggering action, or their hands are otherwise occupied.
        </p>
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Give users a method to cancel any function that they initiate using a single pointer. (<Link.WCAG_2_5_2 />)
                </h3>
                <ul>
                    <li>Don't use the down event to trigger any part of the function, or</li>
                    <li>
                        Initiate the function using the down event, but complete the function only on the up event, and provide a way for
            ...
            <Markup.Dont>
                ...
                <ul>
                    <li>
                        {' '}
                        Provide an alternative method that requires only a single pointer and doesn't depend on the path of the pointer's
                        movement.
                    </li>
                </ul>
                <h3>
