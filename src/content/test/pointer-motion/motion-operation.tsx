...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                Many devices have sensors that can act as inputs and allow users to operate functions by tilting, shaking, or reorienting
                the device. People can't use motion operation if they use a mounted device, they are unable to perform the triggering
                movement, or their hands are otherwise occupied.
            </p>
            ...
            <Markup.PassFail
                ...
                passText={
                    <p>
                        The user can vote by tilting the device or by using <Markup.Term>Up</Markup.Term> and{' '}
                        <Markup.Term>Down</Markup.Term> buttons associated with each photograph. The user can also disable the tilt-to-vote
                        functionality.
                    </p>
                }
            />
