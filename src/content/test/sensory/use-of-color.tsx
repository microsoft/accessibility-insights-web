...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <p>
            Color must not be used as the only visual means for conveying
            meaning.
        </p>

        <h2>Why it matters</h2>
        <p>
            Use of color in web content can enhance aesthetic appeal, usability,
            and accessibility. However, information conveyed{' '}
            <Markup.Emphasis>only</Markup.Emphasis> through color isn't
            available to people with limited color vision.
        </p>
        <p>
            Note: This requirement is intended specifically to help people with
            who have difficulty distinguishing colors. Other requirements,
            related to programmatic access, are intended to help people who are
        ...
        <p>
            <Markup.Emphasis>
                "No one sees color the same way. Ensure I can understand
                content, initiate action or, distinguish one visual element from
        ...
        <h2>How to fix</h2>
        <p>
            Add text or other visual characteristics to supplement the use of
            color.
        </p>
        ...
        <Markup.PassFail
            failText={
                <p>
                    A form indicates a required field by showing its label in a
                    different color (color only).
                </p>
            }
            failExample={`CSS
            [.req {color: red;}]
            ...
            passText={
                <p>
                    The form indicates a required field by showing a red
                    asterisk next to its label (color + shape).
                </p>
            }
            passExample={`CSS
