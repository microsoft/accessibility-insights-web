...
export const infoAndExamples = create(({ Markup, Link }) => <>
   ...
   <h2>Example</h2>
    <Markup.PassFail
        failText={
            <p>A form indicates a required field by showing its label in a different color (color only).</p>
        }
        failExample={
           `CSS
            [.req {color: red;}] 
        ...
        passText={
            <p>The form indicates a required field by showing a red asterisk next to its label (color + shape).</p>
        }
        passExample={
            `CSS
