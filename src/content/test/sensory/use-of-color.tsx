...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                <Markup.Emphasis>
                    "No one sees color the same way. Ensure I can understand content, initiate action or, distinguish one visual element
                    from another without relying on color alone."
                </Markup.Emphasis>
            </p>
