...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                <Markup.Emphasis>
                    "Many people don't know they are sensitive to flashing lights or, prone to seizures until it happens. Do not allow
                    anything to flash or flicker more than three times a second as it may cause me anxiety, confusion, or a seizure. If
                    flickering is essential to any content or functionality, such as a video game, warn me beforehand and allow me to decide
            ...
            <ul>
                ...
                <li>
                    Better: Ensure the relative luminance between the brightest and darkest portions of the flash is less 10% AND the flash
                    does not include any saturated red, or
                </li>
