...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            When color, shape, location, audio, or other sensory characteristics
            are the <Markup.Emphasis>only</Markup.Emphasis> means used to convey
            information, people with disabilities do not have access to the same
            information that others have.
        </p>
        <p>
            Meaning communicated through sensory characteristics must{' '}
            <Markup.Emphasis>also</Markup.Emphasis> be available in a textual
            format that can be viewed by all users and read by screen reader
            software.
        </p>
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    ...
                    <Markup.Emphasis>redundantly</Markup.Emphasis> to convey
                    information.{' '}
                </h3>
                <ul>
                    <li>
                ...
                <h3>
                    Feel free to use audio cues{' '}
                    <Markup.Emphasis>redundantly</Markup.Emphasis> to convey
                    information.
                </h3>
                <ul>
                    <li>
                        Audio cues can draw the user's attention to important
            ...
            <Markup.Dont>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <Markup.Term>Bad</Markup.Term>: To submit the
                                form, press the green button.
                            </li>
                            <li>
                                <Markup.Term>Good</Markup.Term>: To submit the
                                form, press the green 'Go' button.
                            </li>
                            <li>
                                <Markup.Term>Bad</Markup.Term>: To view course
                                descriptions, use the links to the right.
                            </li>
                            <li>
                                <Markup.Term>Good</Markup.Term>: To view course
                                descriptions, use the 'Available courses' links
                                to the right.
                            </li>
                        </ul>
                    </li>
                ...
                <ul>
                    <li>
                        Convey the same information visually, such as through
                        text or icons.
                    </li>
                </ul>
                <h3>
                    Don't show content that flashes more than three times per
                    second. (<Link.WCAG_2_3_1 />)
                </h3>
                <ul>
                    <li>
                        Content that flashes at certain frequencies can trigger
                        seizures in people with photosensitive seizure
                        disorders.
                    </li>
                </ul>
            </Markup.Dont>
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G14">
                Ensuring that information conveyed by color differences is also
                available in text
            </Markup.HyperLink>
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G182">
                Ensuring that additional visual cues are available when text
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G183">
                Using a contrast ratio of 3:1 with surrounding text and
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F13">
                Failure due to having a text alternative that does not include
                information that is conveyed by color in the image
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F73">
                Failure of Success Criterion 1.4.1 due to creating links that
                are not visually evident without color vision
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F81">
                Failure of 1.4.1 due to identifying required or error fields
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/TR/WCAG20-TECHS/G96.html">
                Providing textual identification of items that otherwise rely
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/TR/WCAG20-TECHS/F14.html">
                Failure of Success Criterion 1.3.3 due to identifying content
                only by its shape or location
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/TR/WCAG20-TECHS/F26.html">
                Failure of Success Criterion 1.3.3 due to using a graphical
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Understanding/three-flashes-or-below-threshold.html">
                Understanding Success Criterion 2.3.1: Three Flashes or Below
                Threshold
            </Markup.HyperLink>
        </Markup.Links>
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G19">
                Ensuring that no component of the content flashes more than
