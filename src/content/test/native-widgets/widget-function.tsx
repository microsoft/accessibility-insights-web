...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                However, a native widget can be programmed to function as a custom widget, For example, a button, a text field, and a
                listbox might function together as a combo box.
            </p>
            <p>
            ...
            <ol>
                ...
                <li>
                    Add the correct widget role specified by the design pattern. Exception: A few design patterns do not require a widget
                    role.
                </li>
            </ol>
            <p>
                Most design patterns have additional requirements related to (1) roles, states, properties, and (2) keyboard interaction.
                These requirements are covered in the Custom widgets test.
            </p>
            <h2>Example</h2>
            <Markup.PassFail
                failText={
                    <p>
                        A textbox and list are coded so they function together as a combo box, but they do not have the roles associated
                        with comboboxes.
                    </p>
                }
                passText={
