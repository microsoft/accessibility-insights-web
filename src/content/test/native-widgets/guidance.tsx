...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            ...
            right native HTML widgets and implementing them to spec. If your
            native widgets have (1) accurate programmatically-related labels and
        ...
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    If a native widget functions as a custom widget, give it the
                ...
                <h3>
                    If a widget has visible label or instructions, make sure
                    they are programmatically related to it. (
                    <Link.WCAG_1_3_1 />, <Link.WCAG_2_5_3 />)
                </h3>
                <ul>
                    <li>
                ...
                <h3>
                    Use the widget's accessible name and/or accessible
                    description to identify the expected input (
                    <Link.WCAG_3_3_2 />)
                </h3>
                <ul>
                    <li>
                ...
                <h3>
                    ...
                    , provide the appropriate HTML 5.2 autocomplete attribute. (
                    <Link.WCAG_1_3_5 />)
                </h3>
                <h3>
                    Make sure the widget provides the appropriate cues if it is
                    disabled, read-only, or required. (<Link.WCAG_1_3_1 /> ,{' '}
                    <Link.WCAG_4_1_2 />)
                </h3>
                <ul>
            ...
            <Markup.Dont>
                ...
                <ul>
                    <li>
                        Information communicated visually must also be
