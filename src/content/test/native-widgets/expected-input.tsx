...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                <Markup.Emphasis>
                    "I do not rely on visual cues for reading, I use a screen reader. For any required input you need from me, provide me
                    with general instructions on what is being asked, what is required and, examples of valid input so I can provide the
            ...
            <p>
                ...
                should indicate what action it will initiate. A text field should indicate what type of data is expected and whether a
            ...
            <Markup.PassFail
                failText={
                    <p>
                        An online form has fields for entering first and last names, but both fields share the same accessible name. Users
                        are expected to infer from the placeholder text that the first field is for the first name, and the second field is
                        for the last name.
                    </p>
                }
