...
export const guidance = create(({ Markup }) => <>
    ...
    <p>
        The automated checks focus on issues that can be detected reliably through automation. For example, an automated check can determine whether a button has an accessible name; it does not attempt to determine whether the button has a good accessible name.
    </p>
    <p>
        We use the <Markup.HyperLink href="https://www.deque.com/axe/">axe-core</Markup.HyperLink> rules and engine for our automated checks. Axe-core is open source and actively maintained by a team of expert developers who are committed to quickly eliminating any false positives reported by users.
    </p>
