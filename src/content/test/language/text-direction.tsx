...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <ul>
            ...
            <li>
                If only a passage is read right-to-left, add <Markup.Code>dir="rtl"</Markup.Code> to the element that contains the passage.
            </li>
        </ul>
        ...
        <Markup.PassFail
            failText={
                <p>
                    ...
                    right-to-left. The passage has the correct language (<Markup.Code>lang</Markup.Code>) attribute, but it doesn't have a
                    text direction attribute (<Markup.Code>dir</Markup.Code>).
                </p>
            }
