...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <p>
            If a page or a passage uses a script that is read right-to-left, it
            must have the correct text direction.
        </p>
        ...
        <ul>
            <li>
                If the default language of the page is read right-to-left, add{' '}
                <Markup.Code>dir="rtl"</Markup.Code> to the page's{' '}
        ...
        <Markup.PassFail
            failText={
                <p>
                    The default language of the page is English. The page
                    contains a passage in Arabic, which uses a script that's
                    read right-to-left. The passage has the correct language (
                    <Markup.Code>lang</Markup.Code>) attribute, but it doesn't
                    have a text direction attribute (
                    <Markup.Code>dir</Markup.Code>).
                </p>
            }
            ...
            passText={
                <p>
                    The passage has the correct text direction for Arabic
                    (right-to-left).
                </p>
            }
