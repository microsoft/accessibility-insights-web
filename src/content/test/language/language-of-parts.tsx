...
export const infoAndExamples = createWithTitle(
    {
        pageTitle: 'Language of parts',
    },
    ({ Markup }) => (
        <>
            <p>
                If the language of a passage differs from the default language of the page, the passage must have its own language
                attribute.
            </p>
            ...
            <p>
                ...
                screen readers can use the correct pronunciation; visual browsers can display the correct characters; and media players can
                show captions correctly. All users find it easier to understand the page's content.
            </p>

            <h3>From a user's perspective</h3>
            <p>
                <Markup.Emphasis>
                    "If you do not declare the language of a phrase that comes from a language other than the declared language of the
                    document, my screen reader may mispronounce the word or phrase, confusing me."
                </Markup.Emphasis>
            </p>
