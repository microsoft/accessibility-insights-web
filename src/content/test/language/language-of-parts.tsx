...
export const infoAndExamples = create(({ Markup, Link }) => <>
  ...
  <h1>Language of parts</h1>
    ...
    <h2>How to fix</h2>
    <p>
        Add the correct <Markup.HyperLink href="http://www.iana.org/assignments/language-subtag-registry/language-subtag-registry">
        lang attribute</Markup.HyperLink> to the element that contains the passage.
    </p>
   ...
   <h2>Example</h2>
    <Markup.PassFail
        failText={
            <p>The default language of the page is English. A passage in Spanish doesn't have the correct language (<Markup.Code>lang</Markup.Code>) attribute.</p>
        }
        failExample={
           `<html lang="en-US>
            …
        ...
        passText={
            <p>The passage has the correct language attribute (Latin American Spanish).</p>
        }
        passExample={
            `<html lang="en-US>
            …
