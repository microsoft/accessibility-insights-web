...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                Captions for live presentations allow people who are deaf or have a hearing loss to access information contained in the
                audio track.
            </p>
            ...
            <p>
                <Markup.Emphasis>
                    "I have a hearing impairment, so I rely on captions to enjoy content. Provide captions for events with live audio or
                    video so I can understand and discuss the event with everyone else."
                </Markup.Emphasis>
            </p>
            ...
            <Markup.PassFail
                ...
                passText={
                    <p>
                        The website provides real-time captions for the audio track. The captions include all speech, identify the speakers,
                        and describe other significant audio, such as the buzzers that start and end each match and audience applause.
                    </p>
                }
            />
