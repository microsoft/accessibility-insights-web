...
export const infoAndExamples = create(({ Markup, Link }) => <>
    ...
    <Markup.PassFail
        failText={
            <p>Some of the page's primary content is not contained within the <b>main</b> landmark.</p>
        }
        ...
        passText={
            <p>All of the page's primary content is within the <b>main</b> landmark.</p>
        }
