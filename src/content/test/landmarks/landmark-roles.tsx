...
export const infoAndExamples = create(({ Markup, Link }) => <>
    ...
    <p>
        Assistive technologies allow users to quickly navigate through a page’s landmark regions to see what types of content the page contains. Users might not be able to find the content they want if it has an incorrect landmark role.
    </p>

    <h2>How to fix</h2>
    <p>
        Use the <a href="https://www.w3.org/TR/wai-aria-practices-1.1/#landmark-roles">landmark role</a> that best describes the content.
    </p>
    ...
    <Markup.PassFail
        failText={
            <p>This div functions as a banner, but it has the <b>navigation</b> role.</p>
        }
        ...
        passText={
            <p>The div now has the <b>banner</b> role.</p>
        }
