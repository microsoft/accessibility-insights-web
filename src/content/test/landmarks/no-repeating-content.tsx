...
export const infoAndExamples = createWithTitle(
    {
        pageTitle: 'No repeating content',
    },
    ({ Markup }) => (
        <>
            ...
            <p>
                People with good vision can quickly skip over blocks of content that repeat on multiple pages (such as site navigation
                links) to get to the page's primary content. Users of assistive technologies can't easily skip over repeating content within
                the main landmark.
            </p>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        Site navigation links, which appear on every page, are contained within the <Markup.Term>main</Markup.Term>{' '}
                        landmark.
                    </p>
                }
