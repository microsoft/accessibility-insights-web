...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            Note: Landmarks are not required; however, if landmarks are used,
            they must be used correctly.
        </p>
        <p>
            Landmarks help users understand a web page's structure and
            organization. Adding ARIA landmark roles to a page's sections takes
            ...
            like browser extensions, can use this information to enable or
            enhance navigation.
        </p>
        <p>
        ...
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Contain all visible content within landmark regions. (
                    <Link.WCAG_1_3_1 />)
                </h3>
                <ul>
                    <li>
                        Turn on the <Markup.Term>Landmarks</Markup.Term> visual
                        helper, then zoom out so you can see the entire page. If
                        you see any visible content (like text, images, or
                        controls) outside the dashed borders, that’s a failure.
                    </li>
                    <li>
                        An automated check will fail if the page uses landmarks
                        and some visible content is not contained within a
                        landmark.
                    </li>
                </ul>
                <h3>
                    Choose the landmark role that best describes the area’s
                    content. (<Link.WCAG_1_3_1 />)
                </h3>
                <ul>
                    <li>
                        In the visual helper, each landmark role has a unique
                ...
                <h3>
                    Provide exactly one main landmark in every page. (
                    <Link.WCAG_1_3_1 />, <Link.WCAG_2_4_1 />)
                </h3>
                <ul>
                    <li>
                        An automated check will fail if the page contains more
                        than one main landmark.
                    </li>
                    <li>
                ...
                <h3>
                    Include all of the page's primary content in the main
                    landmark. (<Link.WCAG_1_3_1 />, <Link.WCAG_2_4_1 />)
                </h3>

                <h3>
                    If you use the same landmark role more than once in a page,
                    give each instance a unique accessible label. (
                    <Link.WCAG_2_4_1 />)
                </h3>
                <ul>
                    <li>
                        In the visual helper, accessible labels (
                    ...
                    <li>
                        An automated check will fail if the page contains
                        non-unique landmarks.
                    </li>
                </ul>

                <h3>
                    Provide a descriptive label for any region landmark. (best
                    practice)
                </h3>
                <ul>
                    <li>
                    ...
                    <li>
                        A <Markup.Code>{'<section>'}</Markup.Code> element is a
                        landmark region <Markup.Emphasis>only</Markup.Emphasis>{' '}
                        if it has a label.
                    </li>
                </ul>
                <h3>
                    Provide a visible label for any form landmarks. (best
                    practice)
                </h3>
                <ul>
                    <li>
                ...
                <h3>
                    Use Native html sectioning elements where possible. (best
                    practice)
                </h3>
                <ul>
                    <li>
                        <Markup.Term>Search</Markup.Term> is the only landmark
                        that requires an ARIA <Markup.Term>role</Markup.Term>{' '}
                        attribute. All other landmarks can be implemented using
            ...
            <Markup.Dont>
                <h3>
                    Don’t include any repeated content in the main landmark.
                    (WCAG 2.4.1)
                </h3>
                <ul>
                    <li>
                        The main landmark should not include any blocks of
                        content that repeat on multiple pages, such as site
                        navigation links.
                    </li>
                </ul>
                ...
                <h3>
                    Don't repeat the landmark’s role in its label. (best
                    practice)
                </h3>
                <ul>
                    <li>
                        In the visual helper, the label displayed for each
                        landmark approximates how most screen readers would
                        announce it.
                    </li>
                </ul>
                <h3>
                    Don't use more than one main, banner, or contentinfo
                    landmark.
                </h3>
                <ul>
                    <li>
                        An automated check will fail if the page contains more
                        than one banner or contentinfo landmark.
                    </li>
                    <li>
                        An automated check will fail if a banner, contentinfo,
                        or main landmark is nested within another landmark.
                    </li>
                    <li>
                        Exception: If the page contains nested document or
                        application roles, each one can have its
