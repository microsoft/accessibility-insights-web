...
export const guidance = create(({ Markup, Link }) => <>
   ...
   <h1>Landmarks</h1>
    ...
    <p>
        Note: Landmarks are not required; however, if landmarks are used, they must be used correctly.
    </p>
    <p>
    ...
    <p>
        For more information about how to use ARIA landmarks, see <Markup.HyperLink href="https://www.w3.org/TR/wai-aria-practices-1.1/">
        WAI-ARIA Authoring Practices 1.1: Landmark Regions</Markup.HyperLink>
    </p>
     <p>
    ...
    <Markup.Columns>
        ...
        <ul>
            ...
            <li>An automated check will fail if the page uses landmarks and some visible content is not contained within a landmark.</li>
        </ul>
        <h3>Choose the landmark role that best describes the area’s content. (<Link.WCAG_1_3_1/>)</h3>
        <ul>
        ...
        <ul>
            ...
            <li>A <Markup.Code>{'<section>'}</Markup.Code> element is a landmark region <Markup.Emphasis>only</Markup.Emphasis> if it has a label.</li>
        </ul>
        ...
        <ul>
            <li><Markup.Term>Search</Markup.Term> is the only landmark that requires an ARIA <Markup.Term>role</Markup.Term> attribute. All other landmarks can be implemented using native HTML elements.</li>
        </ul>
        </Markup.Do>
        <Markup.Dont>
        <h3>Don’t include any repeated content in the main landmark. (WCAG 2.4.1)</h3>
        <ul>
            <li>The main landmark should not include any blocks of content that repeat on multiple pages, such as site navigation links.</li>
        </ul>
        ...
        <ul>
            <li>In the visual helper, the label displayed for each landmark approximates how most screen readers would announce it.</li>
        </ul>
        ...
        <ul>
            ...
            <li>Exception: If the page contains nested document or application roles, each one can have its own banner, main and contentinfo landmarks.</li>
        </ul>
        </Markup.Dont>
    </Markup.Columns>
    ...
    <Markup.Links>
        ...
        ARIA Landmarks Example</Markup.HyperLink>
