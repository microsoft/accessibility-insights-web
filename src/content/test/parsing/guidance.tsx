...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>Certain parsing errors can prevent assistive technologies from accurately interpreting web content.</p>
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Ensure that assistive technologies can accurately parse your page’s content. (<Link.WCAG_4_1_1 />)
                </h3>
                <ul>
