    ...
    <>
        ...
        <ol>
            ...
            <ol type="a">
                ...
                <ol type="i">
                    <li>
                        Go to <NewTabLink href="https://validator.w3.org/nu/about.html">https://validator.w3.org/nu/about.html</NewTabLink>.
                    </li>
                ...
                <ul>
                    <li>
                        Navigate to the <Markup.Term>Save</Markup.Term> button and activate it. The bookmarklet will be added to the end of
                        the <Markup.Term>Bookmarks</Markup.Term> bar, and the <Markup.Term>Add bookmark</Markup.Term> dialog will close.
                    </li>
                </ul>
