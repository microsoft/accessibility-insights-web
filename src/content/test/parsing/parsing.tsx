...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <p>
            ...
            accurately interpreting web content. The following parsing issues
            are relevant to this requirement:
        </p>
        <ul>
        ...
        <p>
            ...
            <Markup.HyperLink href="https://validator.w3.org/nu/">
                Nu Html Checker
            </Markup.HyperLink>
            .
        </p>
        ...
        <Markup.PassFail
            failText={
                <p>
                    The checker identified the following error: Element{' '}
                    <Markup.Code>h4</Markup.Code> not allowed as child of
                    element <Markup.Code>span</Markup.Code> in this context.
                </p>
            }
            passText={
                <p>
                    The <Markup.Code>span</Markup.Code> element is replaced by a{' '}
                    <Markup.Code>section</Markup.Code> element, which is a
