...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            ...
            understand the information and use the controls on a website or web app.
        </p>
        <p>People who have trouble focusing might need a way to decrease the distractions created by movement in an application.</p>
        <p>People who use screen readers might find it hard to hear speech output if other audio is playing at the same time.</p>

        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Allow users to turn off, adjust, or extend any time limits set by the content. (<Link.WCAG_2_2_1 />)
                </h3>
                <ul>
                    <li>
                        Allow users to <Markup.Term>turn off the time limit</Markup.Term>, or
                    </li>
                    <li>
                    ...
                    <li>
                        Warn users about the time limit, give them at least 20 seconds to extend the time limit through a simple action
                        (such as pressing the spacebar), and allow them to extend the time limit at least 10 times.
                    </li>
                </ul>
                <h3>
                    Allow users to pause, stop, or hide any content that moves, blinks, or scrolls automatically for more than five seconds.
                    (<Link.WCAG_2_2_2 />)
                </h3>
                <ul>
                ...
                <h3>
                    Allow users to pause, stop, hide, or control the update frequency of any content that updates automatically. (
                    <Link.WCAG_2_2_2 />)
                </h3>

                <h3>
                    Allow users to pause, stop, or mute any audio content that plays automatically for more than three seconds. (
                    <Link.WCAG_1_4_2 />)
                </h3>
                <ul>
                    <li>
                        Good: Provide a mechanism for users to pause, stop, or mute the audio content without affecting the overall system
                        volume, or
                    </li>
            ...
            <Markup.Dont>
                <h3>
                    Don’t use <Markup.Code>http-equiv="refresh"</Markup.Code> on <Markup.Code>{'<meta>'}</Markup.Code> tags. (
                    <Link.WCAG_2_2_1 />)
                </h3>
                <ul>
                ...
                <h3>
                    Don’t use <Markup.Code>{'<blink>'}</Markup.Code> or <Markup.Code>{'<marquee>'}</Markup.Code> tags.(
                    <Link.WCAG_2_2_2 />)
                </h3>
                <ul>
