...
export const infoAndExamples = createWithTitle(
    {
        pageTitle: 'Auto-updating content',
    },
    ({ Markup }) => (
        <>
            ...
            <p>
                Some users might need extra time to read web content before it updates, including people with reading or cognitive disorders
                and people who are not reading in their native language.
            </p>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        A web page containing a news article allows users to post comments about the article. User comments are displayed in
                        a sidebar (adjacent to the article), with the newest comments at the top. The comments are updated automatically
                        every 10 seconds.
                    </p>
                }
                passText={
