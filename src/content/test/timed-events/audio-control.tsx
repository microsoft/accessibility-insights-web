...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                People who use screen readers might struggle to hear speech output when other audio is playing. Because screen reader volume
                is typically controlled by the overall system volume, users must be able to stop or mute the audio content independently.
            </p>
            ...
            <p>
                <Markup.Emphasis>
                    "I use a screen reader and keyboard to operate software and enjoy content. Audio that plays automatically can interrupt
                    the screen reader voice and break my concentration. Do not play audio automatically. If auto-playing audio is essential,
                    provide me an immediate way to stop, pause, mute and control volume so I can focus on the task at hand."
                </Markup.Emphasis>
            </p>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        When a web page opens, ambient music begins playing automatically. The music continues as long as the page is open.
                    </p>
                }
                passText={
                    <p>
                        Music does not start automatically. The user can start the music by selecting a 'Play' button at the top of the
                        page.
                    </p>
                }
            />
            ...
            <Markup.Links>
                ...
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F31">
                    Failure of Success Criterion 3.2.4 due to using two different labels for the same function on different Web pages within
                    a set of Web pages
                </Markup.HyperLink>
            </Markup.Links>
        </>
