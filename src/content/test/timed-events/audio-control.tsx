...
export const infoAndExamples = create(({ Markup, Link }) => <>
    ...
    <p>People who use screen readers might struggle to hear speech output when other audio is playing. Because screen reader volume is typically controlled by the overall system volume, users must be able to stop or mute the audio content independently.</p>
    ...
    <Markup.Links>
        ...
        Understanding Success Criterion 1.4.2: Audio Control</Markup.HyperLink>
    </Markup.Links>

    <h3>Sufficient techniques</h3>
    <Markup.Links>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G171">
        Playing sounds only on user request</Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G60">
        Playing a sound that turns off automatically within three seconds</Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G170">
        Providing a control near the top of the Web page that turns off sounds that play automatically</Markup.HyperLink>
    </Markup.Links>
    ...
    <Markup.Links>
        ...
        Failure of Success Criterion 3.2.4 due to using two different labels for the same function on different Web pages within a set of Web pages</Markup.HyperLink>
    </Markup.Links>
 </>);
