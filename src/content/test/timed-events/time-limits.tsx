...
export const infoAndExamples = create(({ Markup }) => (
    <React.Fragment>
        <h1>Time limits</h1>
        <p>
            If a time limit is set by the content, the user must be able to turn
            off, adjust, or extend the time limit.
        </p>

        <h2>Why it matters</h2>
        <p>
            A 'time limit' is any process that happens automatically after a set
            time or on a periodic basis. Examples of time limits include:
        </p>
        <ul>
        ...
        <p>
            ...
            physical or cognitive disabilities might need more time to
        ...
        <p>
            <Markup.Emphasis>
                "I recently suffered a concussion in a car accident, so it takes
                me a bit longer to understand and make sense of things. Provide
                me a way to increase time limits to 10 times the default
                allotted time or allow me to turn off time-restraints
                altogether."
            </Markup.Emphasis>
        </p>
        ...
        <h2>How to fix</h2>
        <p>
            Use one of the following methods to make the time limit adjustable:
        </p>
        <ul>
            <li>
                Allow users to{' '}
                <Markup.Term>turn off the time limit</Markup.Term>.
            </li>
            <li>
                Allow users to <Markup.Term>adjust the time limit</Markup.Term>{' '}
                so it is at least 10 times longer than the default.
            </li>
            <li>
                Warn users about the time limit, give them at least 20 seconds
                to extend the time limit through a simple action (such as
                pressing the spacebar), and allow them to{' '}
                <Markup.Term>extend the time limit</Markup.Term> at least 10
                times.
            </li>
        </ul>
        ...
        <Markup.PassFail
            failText={
                <p>
                    A web app automatically signs out the user after 10 minutes
                    of activity. No advance warning is provided.
                </p>
            }
            passText={
                <p>
                    After nine minutes of inactivity, the web app displays a
                    message asking if the user wants to continue. The user can
                    respond 'yes' by selecting a button or pressing the
                    keyboard's space bar. If no response is received within one
                    minute, the user is timed out. There is no limit to the
                    number of times a user can continue.
                </p>
            }
        />
