...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <p>
            If content moves, blinks, or scrolls automatically for more than
            five seconds, users must be able to pause, stop, or hide it.
        </p>

        <h2>Why it matters</h2>
        <p>
            Content that moves or conveys a sense of motion can be distracting,
            especially to people with attention deficit disorders. People who
            have reading or cognitive disorders that make it difficult to read
            stationary text might struggle to read moving text.
        </p>

        <h3>From a user's perspective</h3>
        <p>
            <Markup.Emphasis>
                "I enjoy content and operate interfaces via a screen reader and
                keyboard. Objects that refresh, or start automatically interrupt
                me. If it is essential to the solution that something updates or
                plays content automatically, provide me a way to pause, stop or
                disable that content so I can focus on my work."
            </Markup.Emphasis>
        </p>
        ...
        <ul>
            <li>
                Good: Provide a mechanism for users to pause, stop, or hide the
                moving content, or
            </li>
            <li>
        ...
        <Markup.PassFail
            failText={
                <p>
                    A web page has links to news articles. To draw the user's
                    attention to the latest articles, any link published within
                    the past hour is accompanied by a blinking icon. One hour
                    after the link is published, the blinking icon disappears.
                </p>
            }
            passText={
                <p>
                    The icon stops blinking five seconds after the page loads,
                    and the (non-blinking) icon disappears an hour after the
                    link is published.
                </p>
            }
        />
        ...
        <Markup.Links>
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F4">
                Failure due to using text-decoration:blink without a mechanism
                to stop it in less than five seconds
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F50">
                Failure due to a script that causes a blink effect without a
                mechanism to stop the blinking at 3 seconds or less
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F7">
                Failure due to an object or applet, such as Java or Flash, that
                has blinking content without a mechanism to pause the content
                that blinks for more than five seconds
            </Markup.HyperLink>
        </Markup.Links>
    </>
));
