...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <Markup.PassFail
            failText={
                <p>
                    A web page has links to news articles. To draw the user's attention to the latest articles, any link published within
                    the past hour is accompanied by a blinking icon. One hour after the link is published, the blinking icon disappears.
                </p>
            }
            passText={
                <p>
                    The icon stops blinking five seconds after the page loads, and the (non-blinking) icon disappears an hour after the link
                    is published.
                </p>
            }
        />
