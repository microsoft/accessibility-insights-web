...
export const infoAndExamples = create(({ Markup, Link }) => <>
    ...
    <h2>Example</h2>
        <Markup.PassFail
                failText={
                    <p>A web page has links to news articles. To draw the user's attention to the latest articles, any link published within the past hour is accompanied by a blinking icon. One hour after the link is published, the blinking icon disappears.</p>
                }
                passText={
                    <p>The icon stops blinking five seconds after the page loads, and the (non-blinking) icon disappears an hour after the link is published.</p>
                }
            />
    ...
    <Markup.Links>
        ...
        Failure due to including scrolling content where there is not a mechanism to pause and restart the content</Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F47">
        Failure due to using the blink element</Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F4">
        Failure due to using text-decoration:blink without a mechanism to stop it in less than five seconds</Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F50">
        Failure due to a script that causes a blink effect without a mechanism to stop the blinking at 3 seconds or less</Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F7">
        Failure due to an object or applet, such as Java or Flash, that has blinking content without a mechanism to pause the content that blinks for more than five seconds</Markup.HyperLink>
    </Markup.Links>
 </>);
