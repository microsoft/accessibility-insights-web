...
export const infoAndExamples = createWithTitle(
    {
        pageTitle: 'Audio-only equivalent',
    },
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                Text alternatives make the information in audio-only content available to everyone, including people who are deaf, are hard
                of hearing, or have difficulty understanding auditory information. They are also helpful in situations where listening to
                audio content is problematic, such as in environments that are noisy or require silence.
            </p>
