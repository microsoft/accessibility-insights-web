...
export const infoAndExamples = create(({ Markup, Link }) => <>
    ...
    <p>
        Text alternatives make the information in video-only content available to everyone, including people who are blind,
        have low vision, or have difficulty understanding visual information. Audio tracks allow people with and without
        good vision to review content simultaneously.
    </p>
    ...
    <Markup.PassFail
        ...
        passText={
            <>
                The video has a synchronized audio track that describes what's happening in the
                video and provides the same information about ingredients.
            </>
        }
