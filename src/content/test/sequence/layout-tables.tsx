    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                ...
                structured in HTML as a series of rows, they are presented to users row-by-row. If a layout table's expected reading order
                is different from the DOM order, it won't make sense to people who use assistive technologies.
            </p>
            <h2>How to fix</h2>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        The expected reading order of this layout table is column-by-column instead of row-by-row. When read
                        column-by-column, it says, "When life gives you lemons, make lemonade." When read in DOM order, it says, "When gives
                        you make life lemons lemonade."{' '}
                    </p>
                }
