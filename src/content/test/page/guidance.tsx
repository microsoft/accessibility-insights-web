...
export const guidance = create(({ Markup, Link }) => <>
    ...
    <Markup.Columns>
        <Markup.Do>
            ...
            <h3>Give every page a title that describes its topic or purpose. (<Link.WCAG_2_4_2 />)</h3>

            <h3>Give every frame or iframe an accessible name that describes its content.(<Link.WCAG_4_1_2 />)</h3>

            <h3>Provide two or more methods for users to find and navigate to pages in a website. (<Link.WCAG_2_4_5 />)</h3>
            <ul>
    ...
    <Markup.Links>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Understanding/page-titled.html">
            Understanding Success Criterion 2.4.2: Page Titled</Markup.HyperLink>
    </Markup.Links>

    <h4>Sufficient techniques</h4>
    <Markup.Links>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G88">
            Providing descriptive titles for Web pages </Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/html/H25">
            Providing a title using the title element</Markup.HyperLink>
    </Markup.Links>

    <h4>Common failures</h4>
    <Markup.Links>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F25">
            Failure of Success Criterion 2.4.2 due to the title of a Web page not identifying the contents</Markup.HyperLink>
    </Markup.Links>

    <h4>Additional guidance</h4>
    <Markup.Links>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G127">
            Identifying a Web page's relationship to a larger collection of Web pages</Markup.HyperLink>
    </Markup.Links>
