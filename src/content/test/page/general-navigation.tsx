...
export const infoAndExamples = create(({ Markup, Link }) => <>
    ...
    <p>All users benefit when they can find content in a way that's convenient for them. A person using a screen reader or magnifier might find it easier to locate a page using search rather than a navigation menu. A person with a reading disability might prefer a site map or a table of contents.</p>
    ...
    <Markup.PassFail
        failText={
            <p>Each page in a website has a navigation menu with links to all other pages in the site. The page offers no other method for locating pages.</p>
        }
