...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                Assistive technologies help users decide whether a frame or iframe is likely to contain content of interest by announcing
                its accessible name. If a frame or iframe has no accessible name, screen reader users won't know whether it's worth
                exploring.
            </p>
