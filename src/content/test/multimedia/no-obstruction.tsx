...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                The goal of captioning is to provide equal access to all content in a multimedia presentation. If captions obstruct
                meaningful visual content, then people who are deaf or hard of hearing can’t access that content.
            </p>
