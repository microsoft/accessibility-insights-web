...
export const infoAndExamples = create(({ Markup, Link }) => <>
   ...
   <h1>Synchronization</h1>
    ...
    <p>
        Audio description provides access to the visual content in a multimedia presentation. When the audio description isn’t well-synchronized with the video content, listeners can become confused about what’s happening.
    </p>
    ...
    <Markup.PassFail
        failText={
            <p>The audio description track is poorly synchronized with the video’s sound effects (shown in brackets).
            "He turns and looks out the window. [(BANG, THUD) She pulls a gun from her purse]. He falls to the floor."</p>
        }

        passText={
            <p>The audio description track is synchronized in a way that makes the overall narrative more understandable.
            "He turns and looks out the window. [She pulls a gun from her purse. (BANG, THUD)] He falls to the floor."</p>
        }
    />
