...
export const infoAndExamples = create(({ Markup }) => (
    <React.Fragment>
        ...
        <p>
            Audio description provides access to the visual content in a
            multimedia presentation. When the audio description isn’t
            well-synchronized with the video content, listeners can become
            confused about what’s happening.
        </p>

        <h2>How to fix</h2>
        <p>
            Where possible, narrate events "real time", as they are happening
            onscreen. When events are naturally accompanied by audio (such as
            spoken dialog or sound effects), it’s usually best to narrate events
        ...
        <Markup.PassFail
            failText={
                <p>
                    The audio description track is poorly synchronized with the
                    video’s sound effects (shown in brackets). "He turns and
                    looks out the window.{' '}
                    <Markup.Highlight>
                        (BANG, THUD) She pulls a gun from her purse
                    </Markup.Highlight>
            ...
            passText={
                <p>
                    The audio description track is synchronized in a way that
                    makes the overall narrative more understandable. "He turns
                    and looks out the window.{' '}
                    <Markup.Highlight>
                        She pulls a gun from her purse. (BANG, THUD)
                    </Markup.Highlight>{' '}
                    He falls to the floor."
                </p>
            }
