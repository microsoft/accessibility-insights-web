...
export const infoAndExamples = create(({ Markup, Link }) => <>
    ...
    <p>
        By providing auditory access to information in the video track, audio description allows people who are blind or have low vision to listen to pre-recorded multimedia presentations. Note: If the audio track already provides all the information in the video track, no audio description is necessary.
    </p>
    ...
    <ul>
        ...
        <li>Make sure the audio description includes important visual details that cannot be understood from the main soundtrack alone. Include information about actions, characters, scene changes, on-screen text, and other meaningful visual content.</li>
    </ul>

    <Markup.PassFail
        failText={
            <p>A multimedia presentation has no soundtrack with audio description.</p>
        }
        passText={
            <p>The presentation offers an additional soundtrack with audio description.</p>
        }
    />
