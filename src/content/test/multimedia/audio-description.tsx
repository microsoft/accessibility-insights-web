...
export const infoAndExamples = create(({ Markup }) => (
    <React.Fragment>
        ...
        <p>
            By providing auditory access to information in the video track,
            audio description allows people who are blind or have low vision to
            listen to pre-recorded multimedia presentations. Note: If the audio
            track already provides all the information in the video track, no
        ...
        <p>
            <Markup.Emphasis>
                "Provide an audio description track for pre-recorded videos so I
                can understand the story as the content creator imagined it.
                Provide information on scene changes, actors, etc. This allows
                me to understand, enjoy, and share the story with others."
            </Markup.Emphasis>
        </p>
        ...
        <ul>
            <li>
                If the audio description is missing, add it using one of these
                methods:
                <ul>
            ...
            <li>
                Make sure the audio description includes important visual
                details that cannot be understood from the main soundtrack
                alone. Include information about actions, characters, scene
                changes, on-screen text, and other meaningful visual content.
            </li>
        </ul>
        ...
        <Markup.PassFail
            failText={
                <p>
                    A multimedia presentation has no soundtrack with audio
                    description.
                </p>
            }
            passText={
                <p>
                    The presentation offers an additional soundtrack with audio
                    description.
                </p>
            }
        />
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Understanding/audio-description-or-media-alternative-prerecorded">
                Understanding Success Criterion 1.2.3: Audio Description or
