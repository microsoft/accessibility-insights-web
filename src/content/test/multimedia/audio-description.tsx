...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <React.Fragment>
            ...
            <p>
                By providing auditory access to information in the video track, audio description allows people who are blind or have low
                vision to listen to pre-recorded multimedia presentations. Note: If the audio track already provides all the information in
                the video track, no audio description is necessary.
            </p>

            <h3>From a user's perspective</h3>
            <p>
                <Markup.Emphasis>
                    "Provide an audio description track for pre-recorded videos so I can understand the story as the content creator
                    imagined it. Provide information on scene changes, actors, etc. This allows me to understand, enjoy, and share the story
                    with others."
                </Markup.Emphasis>
            </p>
            ...
            <ul>
                ...
                <li>
                    ...
                    alone. Include information about actions, characters, scene changes, on-screen text, and other meaningful visual
                    content.
                </li>
            </ul>
