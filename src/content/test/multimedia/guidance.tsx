...
export const guidance = create(({ Markup, Link }) => <>
    ...
    <p>
        <Markup.Term>Captions</Markup.Term> help people who are deaf or have a hearing loss by providing access to the audio in multimedia content.
        Captions are also helpful to non-native speakers and to people who have difficulty understanding auditory information.
        Captions should convey the dialogue, identify who is speaking, and provide other information conveyed through audio, such as music and sound effects.
    </p>
    <p>
        <Markup.Term>Audio description</Markup.Term> helps blind and low vision people by providing access to the video in multimedia content.
        Audio description should include information about actions, characters, scene changes, on-screen text, and other visual content.
    </p>
    <Markup.Columns>
        <Markup.Do>
            <h3>Provide captions for multimedia content. (<Link.WCAG_1_2_2 />)</h3>
            <ul>
                ...
                <li>  Make sure the captions provide an accurate and complete description of the audio content:
                <ul>
            ...
            <h3>Provide audio description for multimedia content. (<Link.WCAG_1_2_5 />)</h3>
            <ul>
                <li>  Use any of these approaches:
                <ul>
                ...
                <li>  Make sure the audio description includes important visual details that cannot be understood from the main soundtrack alone, such as:
                <ul>
                        <li>Actions</li>
                        <li>Characters</li>
                        <li> Scene changes</li>
                ...
                <li>  Make sure the audio description is synchronized with the video content.
                <ul>
        ...
        <Markup.Dont>
            ...
            <h3>Don’t let captions obscure any meaningful visual content. (<Link.WCAG_1_2_2 />)</h3>
            <ul>
                <li>  Adjust the position or timing of the captions to avoid a conflict.</li>
            </ul>
            <h3>Don’t let the audio description talk over any meaningful audio content.(<Link.WCAG_1_2_5 />)</h3>
            <ul>
    ...
    <Markup.Links>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Understanding/captions-prerecorded.html">
            Understanding Success Criterion 1.2.2: Captions (Prerecorded)</Markup.HyperLink>
    </Markup.Links>
    ...
    <Markup.Links>
        <Markup.HyperLink href="http://www.captioningkey.org/">
            Captioning Key: Guidelines and Preferred Techniques</Markup.HyperLink>
    </Markup.Links>
    ...
    <Markup.Links>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Understanding/audio-description-prerecorded">
            Understanding Success Criterion 1.2.5: Audio Description (Prerecorded)</Markup.HyperLink>
    </Markup.Links>

    <h4>Sufficient techniques</h4>
    <Markup.Links>
        <Markup.HyperLink href="http://www.w3.org/TR/2016/NOTE-WCAG20-TECHS-20161007/G78">
            Providing a second, user-selectable, audio track that includes audio descriptions</Markup.HyperLink>
        <Markup.HyperLink href="http://www.w3.org/TR/2016/NOTE-WCAG20-TECHS-20161007/G173">
            Providing a version of a movie with audio descriptions </Markup.HyperLink>
        <Markup.HyperLink href="http://www.w3.org/TR/2016/NOTE-WCAG20-TECHS-20161007/G8">
            Providing a movie with extended audio descriptions </Markup.HyperLink>
        <Markup.HyperLink href="http://www.w3.org/TR/2016/NOTE-WCAG20-TECHS-20161007/G203">
            Using a static text alternative to describe a “talking head” video </Markup.HyperLink>
    </Markup.Links>
