...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <Markup.PassFail
            failText={
                <p>
                    The captions for a video recording of a play are based on the play’s script rather than its performance. Some dialog is
                    reported incorrectly, and sound effects and audience applause are omitted.
                </p>
            }
