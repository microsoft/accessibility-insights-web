...
export const infoAndExamples = create(({ Markup }) => (
    <React.Fragment>
        <h1>No conflict</h1>
        <p>
            An audio description must not conflict with audible information in
            the sound track.
        </p>

        <h2>Why it matters</h2>
        <p>
            The goal of audio description is to provide equal access all content
            in a multimedia presentation. If the description conflicts with
            meaningful audio content, then people who are blind or have low
            vision can’t access that content.
        </p>

        <h2>How to fix</h2>
        <p>
            Adjust the timing of the description so it does not conflict with
        ...
        <Markup.PassFail
            failText={
                <p>
                    The audio description "talks over" the beginning of a
                    presenter’s speech.
                </p>
            }
            passText={
                <p>
                    The audio description is edited so it ends before presenter
                    begins speaking.
                </p>
            }
        />
