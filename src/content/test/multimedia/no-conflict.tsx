...
export const infoAndExamples = create(({ Markup }) => (
    <React.Fragment>
        ...
        <p>
            The goal of audio description is to provide equal access all content in a multimedia presentation. If the description conflicts
            with meaningful audio content, then people who are blind or have low vision can’t access that content.
        </p>
