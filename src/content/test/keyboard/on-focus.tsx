    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                ...
                re-arranging the content of a page are all changes in context. <Markup.Emphasis>Unexpected</Markup.Emphasis> changes in
                context can be disorienting for anyone, but especially for people with visual disabilities, cognitive limitations, or motor
                impairments. Unless users are notified in advance, they will not expect navigating to an interface component to trigger a
                change in context.
            </p>
