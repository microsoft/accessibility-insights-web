        ...
        <>
            ...
            <p>
                <Markup.Emphasis>
                    ...
                    ensure I can get in and out of any area via keyboard alone. If an action requires a special keyboard command or,
                    something prevents me from progressing with my keyboard, then provide explicit information on how I can leave that
                    area."
                </Markup.Emphasis>
            </p>
            ...
            <ul>
                <li>
                    The text field of a rich text editor can become a keyboard trap if pressing the <Markup.Term>Tab</Markup.Term> key
                    inserts a tab character. The user interface must (1) provide an alternative method for navigating away, and (2) inform
                    users about it.{' '}
                </li>
                <li>
                    Keyboard traps can result from scripts that use <Markup.Term>blur</Markup.Term> or <Markup.Term>keypress</Markup.Term>{' '}
                    events to modify an element's behavior. The script must be modified so it doesn't interfere with default keypress
                    behaviors.
                </li>
                <li>
