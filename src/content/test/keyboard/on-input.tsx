...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                A "change of context" is a major change in the content of a web page that might disorient users who aren't expecting the
                change. For example, opening a new window, moving focus to a different component, going to a new page, or significantly
                re-arranging the content of a page are all changes in context. <Markup.Term>Unexpected</Markup.Term> changes in context can
                be disorienting for anyone, but especially for people with visual disabilities, cognitive limitations, or motor impairments.
                Unless users are notified in advance, they will not expect changing a component's settings to trigger a change in context.
            </p>
            ...
            <h2>How to fix</h2>
            <p>
                Use a different trigger to initiate a change of context. For example, instead of initiating the change of context when a
                radio button is selected, provide a separate command button that triggers the change.
            </p>
            ...
            <Markup.Links>
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F36">
                    Failure due to automatically submitting a form and presenting new content without prior warning when the last field in
                    the form is given a value
                </Markup.HyperLink>
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F37">
                    Failure due to launching a new window without prior warning when the status of a radio button, check box or select list
                    is changed
                </Markup.HyperLink>
            </Markup.Links>
