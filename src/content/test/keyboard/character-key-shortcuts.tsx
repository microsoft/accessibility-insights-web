...
export const infoAndExamples = createWithTitle(
    {
        pageTitle: 'Character key shortcuts',
    },
    ({ Markup }) => (
        <>
            ...
            <p>
                ...
                errant keypress or utterance—with potentially serious consequences. To avoid unintended input, users must be able to turn
                off single-key shortcuts or to remap them to include non-character keys, such as Alt or Ctrl. Because screen reader users
                typically make heavy use of keyboard shortcuts, they also benefit from the ability to remap.
            </p>

            <h2>How to fix</h2>
            <p>
                If a keyboard shortcut is implemented using only letter, number, punctuation, or symbol characters, make sure at least one
            ...
            <Markup.PassFail
                failText={
                    <p>
                        A messaging app uses the letter "N" as a keyboard shortcut for starting a new message. The shortcut is deactivated
                        when focus is in a text editing field, but otherwise it is always active. The app does not allow the user to turn
                        off or remap shortcuts.
                    </p>
                }
                passText={
                    <p>The messaging app allows users to disable keyboard shortcuts or remap them to include the Ctrl or Alt keys.</p>
                }
            />
