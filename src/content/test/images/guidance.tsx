...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            Images are intrinsically inaccessible to people who can't see them.
            Care must be taken to ensure that images are used accessibly:
            <ul>
                <li>
                    Correct markup allows assistive technologies to distinguish
                    between meaningful and decorative images and handle them
                    appropriately.
                </li>
                <li>
                    Good text alternatives enable screen readers to convey the
                    content of meaningful images available to everyone.
                </li>
                <li>
                    Actual text is better than images of text because users can
                    adjust on-screen text to make it legible.{' '}
                </li>
                <li>
                    Where CAPTCHA is used to screen out robots, providing
                    alternative versions can make it easier for people with
        ...
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Mark every image correctly as either meaningful or
                    decorative. (<Link.WCAG_1_1_1 />)
                </h3>
                <ul>
                    <li>
                        Determine whether each image is meaningful or
                        decorative:
                        <ul>
                            <li>
                                If an image conveys information that isn't
                                available through other page content, it's{' '}
                                <Markup.Emphasis>meaningful</Markup.Emphasis>.{' '}
                            </li>
                            <li>
                                If an image could be removed from the page with
                                no impact on meaning for function, it's{' '}
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                For {'<img>'} elements, add a non-empty{' '}
                                <Markup.Code>alt</Markup.Code> attribute.
                            </li>
                            <li>
                                For icon fonts, {'<svg>'} images, and CSS
                                background images, add{' '}
                                <Markup.Code>role="img"</Markup.Code> and a
                                non-empty <Markup.Code>aria-label</Markup.Code>{' '}
                                or <Markup.Code>aria-labelledby</Markup.Code>{' '}
                                attribute.
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                For <Markup.Code>{`<img>`}</Markup.Code>{' '}
                                elements, add an empty{' '}
                                <Markup.Code>alt</Markup.Code> attribute (
                                <Markup.Code>alt</Markup.Code> or{' '}
                                <Markup.Code>alt=""</Markup.Code>).
                            </li>
                            <li>
                                For icon fonts and{' '}
                                <Markup.Code>{`<svg>`}</Markup.Code> images, add{' '}
                                <Markup.Code>role="img"</Markup.Code> and{' '}
                                <Markup.Code>aria-hidden="true"</Markup.Code>.
                            </li>
                            <li>
                                For CSS background images, no additional markup
                                is needed.
                            </li>
                        </ul>
                    </li>
                ...
                <h3>
                    For each meaningful image, provide a text alternative that
                    serves the same purpose and presents the same information as
                    the image itself. (<Link.WCAG_1_1_1 />)
                </h3>
                <ul>
                    <li>
                        For simple images, provide an accessible name (using,{' '}
                        <Markup.Code>alt</Markup.Code>,{' '}
                        <Markup.Code>aria-label</Markup.Code>, or{' '}
                        <Markup.Code>aria-labelledby</Markup.Code>).
                    </li>
                    <li>
                        For complex images, use the accessible name to identify
                        the image's purpose and add a description (
                        <Markup.Code>aria-describedby</Markup.Code>) to
                        communicates its full meaning.
                    </li>
                </ul>

                <h3>
                    If you use non-text CAPTCHA, provide at least visual and
                    auditory versions. (<Link.WCAG_1_1_1 />)
                </h3>
                <ul>
                    <li>
                        yet, use non-interactive methods to detect robots, such
                        as monitoring mouse and keyboard input.
                    </li>
                </ul>
            </Markup.Do>
            ...
            <Markup.Dont>
                <h3>
                    Don't use images of text unless a specific visual
                    presentation is essential. (<Link.WCAG_1_4_5 />)
                </h3>
                <ul>
                    <li>
                        Where possible, use actual text instead of images of
                        text.
                    </li>
                    <li>
                        Alternatively, provide functionality that allows users
                        to customize the text within the image.
                    </li>
                </ul>
            </Markup.Dont>
        </Markup.Columns>
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G94">
                Providing short text alternative for non-text content that
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/aria/ARIA10">
                Using aria-labelledby to provide a text alternative for non-text
                content
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G196">
                Using a text alternative on one item within a group of images
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/html/H86">
                Providing text alternatives for ASCII art, emoticons, and
                leetspeak
            </Markup.HyperLink>
        </Markup.Links>
        ...
        <Markup.Links>
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/html/H67">
                Using null alt text and no title attribute on img elements for
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F3">
                Failure of Success Criterion 1.1.1 due to using CSS to include
                images that convey important information
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F38">
                Failure of Success Criterion 1.1.1 due to not marking up
                decorative images in HTML in a way that allows assistive
                technology to ignore them
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F39">
                Failure of Success Criterion 1.1.1 due to providing a text
                alternative that is not null (e.g., alt="spacer" or alt="image")
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F65">
                ...
                attribute or text alternative on img elements, area elements,
                and input elements of type "image"
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F71">
                Failure of Success Criterion 1.1.1 due to using text look-alikes
                to represent text without providing a text alternative
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F72">
                Failure of Success Criterion 1.1.1 due to using ASCII art
        ...
        <Markup.Links>
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G73">
                Providing a long description in another location with a link to
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G74">
                ...
                with a reference to the location of the long description in the
                short description
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G92">
                Providing long description for non-text content that serves the
                same purpose and presents the same information
            </Markup.HyperLink>
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G143">
                Providing a text alternative that describes the purpose of the
                CAPTCHA {' '}
            </Markup.HyperLink>
        </Markup.Links>
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F13">
                Failure of Success Criterion 1.1.1 and 1.4.1 due to having a
                text alternative that does not include information that is
                conveyed by color differences in the image
            </Markup.HyperLink>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F20">
                Failure of Success Criterion 1.1.1 and 4.1.2 due to not updating
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F30">
                Failure of Success Criterion 1.1.1 and 1.2.1 due to using text
            ...
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F67">
                ...
                long descriptions for non-text content that does not serve the
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G144">
                Ensuring that the Web Page contains another CAPTCHA serving the
