...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            <p>
                If a non-text CAPTCHA is used, alternative methods must be provided for both users without vision and users without hearing.
            </p>

            <h2>Why it matters </h2>
            <p>
                A traditional CAPTCHA requires the user to perform a visual task that's intended to be easy for humans but difficult for
                robots. Unfortunately, such a task can be impossible for people with visual disabilities, with the result that they're
                denied access. Providing an alternative CAPTCHA (such as text or auditory) increases the likelihood that users will be able
            ...
            <Markup.PassFail
                ...
                passText={
                    <p>
                        The web page requires the user to select a checkbox that says, "I am a human." It monitors mouse and keyboard
                        activity to determine whether input is being provided by a human or a robot.
                    </p>
                }
            />
