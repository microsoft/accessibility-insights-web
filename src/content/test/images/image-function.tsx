    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                ...
                decorative, screen readers will assume it's meaningful. In an attempt to communicate the image's meaning, they might
                announce the image's filename.
            </p>
            ...
            <ol>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            ...
                            <Markup.Code>alt</Markup.Code>, <Markup.Code>aria-label</Markup.Code>,{' '}
                            <Markup.Code>aria-labelledby</Markup.Code>, or <Markup.Code>title</Markup.Code> attribute. (Only{' '}
                            <Markup.Code>{'<img>'}</Markup.Code>, <Markup.Code>{'<input>'}</Markup.Code>, and{' '}
                            <Markup.Code>{'<area>'}</Markup.Code> elements can have <Markup.Code>alt</Markup.Code> attributes.)
                        </li>
                        <li>
                        ...
                        <li>
                            If it's a CSS background image, also add a text element that conveys the image's information and is visible when
                            CSS is turned off.
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            And it's an icon font or <Markup.Code>{'<svg>'}</Markup.Code> image, add <Markup.Code>role="img"</Markup.Code>{' '}
            ...
            <Markup.PassFail
                failText={
                    <p>
                        A web page about pets has an image link that opens a page about hamsters. Because the image of the hamster is
                        redundant to the text link, the image is decorative, and its alt attribute is redundant. The screen reader will
                        announce "Hamsters" twice.
                    </p>
                }
                ...
                passText={
                    <p>
                        The image has an empty <Markup.Code>alt</Markup.Code> attribute, so screen readers will announce "Hamsters" only
                        once.
                    </p>
                }
            ...
            <Markup.Links>
                ...
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F38">
                    Failure of Success Criterion 1.1.1 due to not marking up decorative images in HTML in a way that allows assistive
                    technology to ignore them
                </Markup.HyperLink>
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F39">
                    Failure of Success Criterion 1.1.1 due to providing a text alternative that is not null (e.g., alt="spacer" or
                ...
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F65">
                    Failure of Success Criterion 1.1.1 due to omitting the alt attribute or text alternative on img elements, area elements,
