...
export const infoAndExamples = create(({ Markup }) => <>
    ...
    <p>People with low vision, visual tracking problems, or reading disabilities might need to adjust the way text is displayed
        to make it readable. Browsers and browser extensions allow users to adjust actual text, but not the text in images of text.</p>

    <h2>How to fix</h2>
    <p>Use one of the following methods to make text adjustable:</p>
    <ul>
        <li>Good: Provide functionality allowing users to adjust the way text is displayed in images of text, including the font
            size, font family, foreground/background colors, line spacing, and alignment; or</li>
    ...
    <Markup.PassFail
        failText={
            <p>An image of text is used in an image button where no specific appearance is required.</p>
        }

        failExample={
            <Markup.CodeExample title="HTML">{
        ...
        passText={
            <p>A submit button uses actual text and CSS styling to achieve the desired appearance.</p>
        }

        passExample={[
            <Markup.CodeExample title="CSS">{
                `<style>
                .button {
