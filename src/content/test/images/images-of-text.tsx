...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                People with low vision, visual tracking problems, or reading disabilities might need to adjust the way text is displayed to
                make it readable. Browsers and browser extensions allow users to adjust actual text, but not the text in images of text.
            </p>

            <h3>From a user's perspective</h3>
            <p>
                <Markup.Emphasis>
                    "Images of text content are invisible to me. Do not use images of text for anything other than logos and decorative
                    items."
                </Markup.Emphasis>
            </p>
            ...
            <ul>
                <li>
                    Good: Provide functionality allowing users to adjust the way text is displayed in images of text, including the font
                    size, font family, foreground/background colors, line spacing, and alignment; or
                </li>
