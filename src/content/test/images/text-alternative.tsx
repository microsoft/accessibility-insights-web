...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <ul>
            <li>
                If the image's purpose and content <Markup.Emphasis>can</Markup.Emphasis> be communicated in a short text string, give it an
                accessible name:
                <ul>
                    <li>
        ...
        <h3>Special cases</h3>
        <p>
            Sometimes an image is part of a process where revealing the image's content would invalidate the process (such as a CAPTCHA test
            to prove you are human, or a test of visual skills). In this case, describe the purpose of the image, but do not disclose its
            full content.
        </p>
        ...
        <p>
            ...
            non-text content so my screen reader or braille display can describe the content and help me understand how the content shapes
        ...
        <Markup.PassFail
            failText={
                <p>
                    The banner of Clive County's website includes an image link showing the county logo. Clicking the logo navigates to the
                    site's home page. The logo's text alternative is "Logo," which does not communicate the purpose or content of the image
                    link.
                </p>
            }
            passText={
