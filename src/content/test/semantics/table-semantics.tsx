...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                When the semantics in a data table are suppressed, critical relationships are hidden from people who use assistive
                technologies. Moreover, they can't use the standard navigational shortcuts for data tables.
            </p>
            <p>
                When the semantics in a layout table are not suppressed, assistive technologies communicate relationships that don't
                actually exist.
            </p>
