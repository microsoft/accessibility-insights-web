...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                The <Markup.Code>{'<blockquote>'}</Markup.Code> is a semantic element that conveys to assistive technologies that it
                contains a quote. People who use assistive technologies might be confused if this semantic element is used instead as a
                quick way to style non-quote text.
            </p>
            <h2>How to fix</h2>
            <p>
