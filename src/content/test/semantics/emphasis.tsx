...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                People with good vision can infer from visual styling that a word or phrase is especially important. For example, it might
                be displayed using bold or italic font. Unless the visually emphasized word or phrase is also contained in a semantically
                correct element, people who use screen readers won't know that it's emphasized.
            </p>
            <h2>How to fix</h2>
            <p>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        the entire page. By default, browsers will render the text using a bold font. A sighted person will find it easy to
                        spot bold text when they skim the page.
                    </li>
                </ul>
            </p>
            <Markup.PassFail
                failText={
                    <p>
                        Italic font is applied to visually emphasize certain words in a paragraph, but the emphasis is not conveyed to
