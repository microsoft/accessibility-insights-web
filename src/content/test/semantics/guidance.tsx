...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            Assistive technologies use semantic markup to communicate meaning to
            users. When semantics are ignored or used incorrectly, users are
            likely to be confused. To ensure the best possible experience for
            all users, use the correct semantic elements and properties, and add
            CSS styling to achieve your desired visual presentation.
        </p>

        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Code lists with semantically correct elements. (
                    <Link.WCAG_1_3_1 />)
                </h3>
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>
                                Use the <Markup.Code>{'<ul>'}</Markup.Code>{' '}
                                element for the container.
                            </li>
                            <li>
                                Use the <Markup.Code>{'<li>'}</Markup.Code>{' '}
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                Use the <Markup.Code>{'<ol>'}</Markup.Code>{' '}
                                element for the container.
                            </li>
                            <li>
                                Use the <Markup.Code>{'<li>'}</Markup.Code>{' '}
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                Use the <Markup.Code>{'<dl>'}</Markup.Code>{' '}
                                element for the container.
                            </li>
                            <li>
                                Use the <Markup.Code>{'<dt>'}</Markup.Code>{' '}
                                element for terms.
                            </li>
                            <li>
                                Use the <Markup.Code>{'<dd>'}</Markup.Code>{' '}
                ...
                <h3>
                    Contain words and phrases that are visually emphasized in
                    semantically correct containers. (<Link.WCAG_1_3_1 />)
                </h3>
                <ul>
                    <li>
                        Use the <Markup.Code>{'<em>'}</Markup.Code> element when
                        you want to stress a word or phrase within the context
                        of a sentence or paragraph.
                    </li>
                    <li>
                        Use the <Markup.Code>{'<strong>'}</Markup.Code> element
                        when the word or phrase is important within the context
                        of the entire page.
                    </li>
                </ul>
            </Markup.Do>
            <Markup.Dont>
                <h3>
                    Don't use CSS :before or :after to insert meaningful content
                    in the page. (<Link.WCAG_1_3_1 />)
                </h3>
                <ul>
                    <li>
                        Some people with visual disabilities need to modify or
                        disable CSS styling, which might cause inserted content
                        to move or disappear entirely.
                    </li>
                </ul>
                <h3>
                    Don’t code elements in a data table as presentational. (
                    <Link.WCAG_1_3_1 />)
                </h3>
                <ul>
                    <li>
                        When <Markup.Code>role="presentation"</Markup.Code> is
                        applied to a data table element, assistive technologies
                        can't communicate to users the relationships between
                        cells and row or column headers.
                    </li>
                </ul>
                <h3>
                    Don't use the <Markup.Code>{'<blockquote>'}</Markup.Code>{' '}
                    element to indent non-quote text. (<Link.WCAG_1_3_1 />)
                </h3>
                <ul>
                    <li>
                        Use CSS <Markup.Code>margin</Markup.Code> properties to
                        create space around blocks of text.
                    </li>
                </ul>
                <h3>
                    Don't use white space characters to increase the spacing
                    between letters of a word. (<Link.WCAG_1_3_1 />)
                </h3>
                <ul>
                    <li>
                        Use the CSS <Markup.Code>letter-spacing</Markup.Code>{' '}
                        attribute to adjust the spacing between letters.
                    </li>
                </ul>
            </Markup.Dont>
        </Markup.Columns>
        ...
        <Markup.Links>
            <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F87">
                Failure of Success Criterion 1.3.1 due to inserting
                non-decorative content by using :before and :after
