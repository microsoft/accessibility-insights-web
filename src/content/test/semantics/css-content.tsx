...
export const infoAndExamples = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            Some people with visual disabilities need to customize the styling of a web page to see its content. When they modify or disable
            CSS styling, content inserted using <Markup.Code>:before</Markup.Code> or <Markup.Code>:after</Markup.Code> might move or
            disappear entirely.
        </p>
        <h2>How to fix</h2>
        <ul>
        ...
        <Markup.PassFail
            failText={
                <p>
                    An online book review site uses <Markup.Code>:before</Markup.Code> (and its content property) to indicate the titles of
