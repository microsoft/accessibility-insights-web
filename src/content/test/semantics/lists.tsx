...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                When lists are coded with semantically correct elements, navigating them is easier for people who use assistive
                technologies. For example, most assistive technologies allow users to navigate from the first list item to the last, or to
