    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                ...
                assistive technologies might not recognize the word, with the result that they mispronounce it or spell it out. In some
                scripts, such as Kanji, adding a space between characters can completely change their meaning.
            </p>
            <h2>How to fix</h2>
            <p>
                Use the CSS <Markup.Code>letter-spacing</Markup.Code> property to adjust the space between the letters in a word. To
                maintain consistent spacing when users adjust the font size, use a relative unit, such as <Markup.Code>em</Markup.Code>.
            </p>
            <Markup.PassFail
