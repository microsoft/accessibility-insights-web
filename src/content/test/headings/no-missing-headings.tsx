...
export const infoAndExamples = create(({ Markup }) => <>
    ...
    <h2>How to fix</h2>
    <p>
        Re-implement using a heading tag. (You could add role="heading" to a different element, but the first rule of ARIA is to use native HTML elements where possible, instead of repurposing an element by adding ARIA.)
    </p>

    <h2>Example</h2>
    <Markup.PassFail
        failText={
            <p>This element looks like a heading, but it isn't coded as a heading.</p>
        }
        failExample={
            `[<p style="font-size:2em; font-weight:700;] color:#cc0000">About Accessibility Insights for Web</p>`
        }
        passText={
            <p>The element is coded as a heading.</p>
        }
        passExample={
            `[<h1 ]style="color:#cc0000">About Accessibility Insights for Web[</h1>]`
        }
    />
    ...
    <Markup.Links>
        <Markup.HyperLink href="https://www.w3.org/TR/WCAG20-TECHS/G130.html">
            Providing descriptive headings</Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/TR/WCAG20-TECHS/H42.html">
            Using h1-h6 to identify headings.</Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/TR/WCAG20-TECHS/G141.html">
            Organizing a page using headings</Markup.HyperLink>
    </Markup.Links>
