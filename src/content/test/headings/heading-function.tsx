...
export const infoAndExamples = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            The function of a heading is to label a section of content.
            Assistive technologies allow users to quickly navigate through the
            coded headings on the page to find content of interest. Users are
            likely to be confused if they unexpectedly navigate to text that
            doesn't function as a heading.
        </p>

        <h2>How to fix</h2>

        <p>
            Re-implement without using heading tag or{' '}
            <Markup.Code>role="heading"</Markup.Code>.
        </p>
        ...
        <Markup.PassFail
            failText={
                <p>
                    This button is coded as a heading solely to achieve a
                    desired appearance. It doesn't function as a heading.
                </p>
            }
            failExample={`<button>[<h2>]Save[</h2>]</button>`}
            passText={
                <p>
                    The heading tag is removed, and the desired appearance is
                    achieved through styling.
                </p>
            }
