...
export const infoAndExamples = createWithTitle(
    {
        pageTitle: 'Heading function',
    },
    ({ Markup, Link }) => (
        <>
            <p>
                An element <Markup.Emphasis>coded</Markup.Emphasis> as a heading must <Markup.Emphasis>function</Markup.Emphasis> as a
                heading.
            </p>
            <h2>Why it matters</h2>
            <p>
                The function of a heading is to label a section of content. Assistive technologies allow users to quickly navigate through
                the coded headings on the page to find content of interest. Users are likely to be confused if they unexpectedly navigate to
