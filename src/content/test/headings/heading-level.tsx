...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                Heading levels communicate the relative importance of headings within a page. People with good vision can infer heading
                levels through visual cues—higher-level headings typically have greater visual prominence than lower-level headings. Users
                of assistive technology rely on programmatic cues to perceive heading levels.
            </p>
            <h2>How to fix</h2>
