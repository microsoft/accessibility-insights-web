...
<h2>Why it matters</h2>
    <p>
        Heading levels communicate the relative importance of headings within a page. 
        People with good vision can infer heading levels through visual cues—higher-level headings typically have greater visual prominence than lower-level headings. 
        Users of assistive technology rely on programmatic cues to perceive heading levels.
    </p>

<h2>How to fix</h2>
    <p>
        Specify a programmatic heading level that matches the visual level. 
    </p>
...
<h2>Example</h2>
    ...
    <Markup.PassFail
        failText={
            <p>Both headings are coded as level 2, but styling makes the second heading visually less prominent.</p>
        }
        failExample={
           `<!--section title-->
        ...
        passText={
            <p>The second heading is re-coded as level 3.</p>
        }
        passExample={
            `
                <!--section title-->
