...
export const infoAndExamples = createWithTitle(
    {
        pageTitle: 'Error identification',
    },
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                Identifying and describing input errors in text allows people who use assistive technologies to learn what went wrong. It
                also helps people with certain cognitive disabilities who have difficulty understanding the meaning of icons and other
                visual cues.
            </p>
