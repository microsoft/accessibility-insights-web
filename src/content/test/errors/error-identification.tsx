...
export const infoAndExamples = create(({ Markup }) => <>
    ...
    <p>Identifying and describing input errors in text allows people who use assistive technologies to learn what went wrong. It also helps people with certain cognitive disabilities who have difficulty understanding the meaning of icons and other visual cues.</p>

    <h2>How to fix</h2>
    <p>Use text to identify and describe input errors. (It's ok if you <Markup.Emphasis>also</Markup.Emphasis> provide visual cues, such as color changes or error icons.)</p>
