...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <p>
            ...
            people who are blind or have low vision can't. Instead, assistive technologies must be able to programmatically determine when a
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        information is added to the status message in meaningful order, and old information might disappear (such as a chat
