...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <p>
            If submitting data might have serious consequences, users must be
            able to correct the data input before finalizing a submission.
        </p>

        <h2>Why it matters</h2>
        <p>
            Error prevention benefits everyone, especially people with reading
            or motor disabilities that make them more likely to make mistakes.
            Error prevention is critical when using a web page can:
        </p>
        <ul>
        ...
        <ul>
            ...
            <li>
                User input is checked for errors, and users have an opportunity
                to make corrections.
            </li>
            <li>
                Users can review, correct, and confirm their input before
        ...
        <Markup.PassFail
            failText={
                <p>
                    Unless a data validation error is detected, an online
                    shopping site initiates a credit card transaction as soon as
                    all required input is entered. The user has no opportunity
                    to review their input before the transaction occurs.
                </p>
            }
            passText={
                <p>
                    Before initiating a credit card transaction, the site
                    provides the user a summary of their input, including the
                    items selected, the payment method, and the shipping
                    address. The user can make corrections before initiating the
