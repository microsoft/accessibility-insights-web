...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <Markup.PassFail
            failText={
                <p>
                    Unless a data validation error is detected, an online shopping site initiates a credit card transaction as soon as all
                    required input is entered. The user has no opportunity to review their input before the transaction occurs.
                </p>
            }
            passText={
                <p>
                    Before initiating a credit card transaction, the site provides the user a summary of their input, including the items
                    selected, the payment method, and the shipping address. The user can make corrections before initiating the credit card
                    transaction.
                </p>
            }
        />
