...
export const infoAndExamples = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            If an input error is automatically detected, guidance for correcting
            the error must be provided.
        </p>

        <h2>Why it matters</h2>
        <p>
            Providing instructions for correcting input errors helps everyone
            recover from mistakes, especially people who have learning
            disabilities. It also helps people with motion impairment by
            reducing the number of times they need to enter an input value.
        </p>

        <h3>From a user's perspective</h3>
        <p>
            <Markup.Emphasis>
                "Help me recover from mistakes by providing me the location of
                input mistakes and examples of valid input so I can get back to
        ...
        <h2>How to fix</h2>
        <p>
            Provide suggestions for correcting input errors, including allowed
            values and expected format.
        </p>
        ...
        <Markup.PassFail
            failText={
                <p>
                    A user booking a flight accidentally entered a flight date
                    in the past. The web page identifies and describes the input
            ...
            passText={
                <p>
                    The web page provides a suggestion for correcting the input
                    error.
                </p>
            }
            passExample={
