...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                <Markup.Emphasis>
                    "Help me recover from mistakes by providing me the location of input mistakes and examples of valid input so I can get
                    back to work and complete the task."
                </Markup.Emphasis>
            </p>
            <h2>How to fix</h2>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        A user booking a flight accidentally entered a flight date in the past. The web page identifies and describes the
                        input error but doesn't provide suggestions for correcting it.
                    </p>
                }
