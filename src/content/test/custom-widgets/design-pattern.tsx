...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                Custom widgets are interactive interface components designed to meet unique UX needs. They are created by adding
                functionality to native widgets or to non-interactive components such as <Markup.Code>{`<div>`}</Markup.Code> elements.
            </p>
            <p>
                Custom widgets are most appropriate for complex controls (such as a text field, listbox, and button that together function
                as a combo box). For simple controls (such as buttons or links), it's better to use native widgets, as they require
                significantly less coding to make them accessible.
            </p>
            <p>
                A custom widget usually requires an ARIA widget role to communicate the correct function to assistive technologies and
                enable them to interact with the widget.
            </p>
            <h2>How to fix</h2>
            <p>
            ...
            <ol>
                <li>
                    ...
                    <Markup.HyperLink href="https://www.w3.org/TR/wai-aria-practices-1.1/#aria_ex">ARIA design patterns</Markup.HyperLink>{' '}
                    for custom widgets.
                </li>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        ...
                        <Markup.HyperLink href="https://www.w3.org/TR/wai-aria-practices-1.1/#alertdialog">alert dialog</Markup.HyperLink>,
                        but the <Markup.Code>{`<div>`}</Markup.Code> has been given the more generic role of a{' '}
                ...
                passText={
                    <p>
                        ...
                        <Markup.Code>alertdialog</Markup.Code> role enables browsers and assistive technologies to handle it differently
                        from other modal dialogs, for example, by playing a system alert sound when it opens.
                    </p>
                }
            />
            <h2>More examples</h2>
