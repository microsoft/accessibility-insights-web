...
export const infoAndExamples = createWithTitle(
    {
        pageTitle: 'Keyboard interaction',
    },
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                For a web page to be accessible, all of its interactive interface components—including custom widgets—must be operable using
                a keyboard. Supporting the standard keybord interactions specified by the design patterns makes it easy for keyboard and
