...
export const infoAndExamples = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            A custom widget must support the keyboard interaction specified by
            its design pattern.
        </p>

        <h2>Why it matters</h2>
        <p>
            For a web page to be accessible, all of its interactive interface
            components—including custom widgets—must be operable using a
            keyboard. Supporting the standard keybord interactions specified by
            the design patterns makes it easy for keyboard and assistive
        ...
        <ol>
            ...
            <li>
                ...
                specifications for "Keyboard interaction."
            </li>
        </ol>
        <h2>How to fix</h2>
        ...
        <Markup.PassFail
            failText={
                <p>
                    A custom button opens a dialog. It does not support the
                    keyboard interaction specified by the{' '}
                    <Markup.HyperLink href="https://www.w3.org/TR/wai-aria-practices-1.1/#button">
                        button design pattern
                    </Markup.HyperLink>
                    : (1) It is not focusable. (2) When the button is clicked,
                    focus does not move into the dialog.
                </p>
            }
            passText={
                <p>
                    ...
                    , the button is focusable, and clicking it moves focus into
                    the dialog.
                </p>
            }
        />
