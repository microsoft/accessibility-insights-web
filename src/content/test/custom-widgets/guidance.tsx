...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Use the right ARIA widget role for your custom widget. (<Link.WCAG_4_1_2 />)
                </h3>
                <ul>
                    <li>
                ...
                <h3>
                    Use the widget's accessible name or accessible description to identify the expected input. (<Link.WCAG_3_3_2 />)
                </h3>
                <ul>
                    <li>
            ...
            <Markup.Dont>
                ...
                <ul>
                    <li>
                        State information communicated visually (for example, graying out a disabled widget) must also be communicated
                        programmatically (for example, by adding the aria-disabled attribute).
                    </li>
                </ul>
