    ...
    ({ Markup, Link }) => (
        <>
            ...
            <ol>
                ...
                <li>
                    Make sure your custom widget follows the design pattern's specifications for "WAI-ARIA Roles, States, and Properties."
                </li>
            </ol>
            <h2>Example</h2>
            <Markup.PassFail
            ...
            <li id="entree2">Roasted Veggie Casserole</li>
                ...
                passText={
                    <p>
                        ...
                        <Markup.HyperLink href="https://www.w3.org/TR/wai-aria-practices-1.1/#Listbox">listbox</Markup.HyperLink> spec: (1)
                        The <Markup.Code>{`<ul>`}</Markup.Code> that contains all of the listbox options has{' '}
                        <Markup.Code>role="listbox"</Markup.Code>. (2) The <Markup.Code>{`<ul>`}</Markup.Code> has an accessible name
                        through an <Markup.Code>aria-labelledby</Markup.Code> attribute. (3) Each <Markup.Code>{`<li>`}</Markup.Code> has{' '}
                        <Markup.Code>role="option"</Markup.Code>. (4) The selected option has{' '}
