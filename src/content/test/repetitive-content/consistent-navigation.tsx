...
export const infoAndExamples = create(({ Markup }) => (
    <>
        ...
        <p>
            When navigational mechanisms (typically links) appear in the same order on each page of a website or web app, users can navigate
            within and across pages more efficiently. Consistent navigation is helpful for everyone, especially people who use screen
            readers or screen magnifiers and people with cognitive disabilities.
        </p>
        <h3>From a user's perspective</h3>
        <p>
            <Markup.Emphasis>
                "I have trouble quickly moving around a website and may sometimes, forget where I am or, where I started. Place navigation
                controls in a consistent location and order wherever they appear so I can rely on them to help keep me re-orient."
            </Markup.Emphasis>
        </p>
