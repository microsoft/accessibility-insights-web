    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                ...
                content. Otherwise, reaching the primary cotent could require dozens of keystrokes. People with limited mobility could find
                this task difficult or painful, and people who use screen readers could find it tedious to listen as each repeated element
                is announced.
            </p>
            ...
            <p>
                <Markup.Emphasis>
                    "I navigate content and interfaces using a screen reader and a keyboard. Repeated blocks of navigation and content force
                    me to 're-read' everything as I work back and forth over the interface to complete a task or, enjoy content. Allow me a
                    way to 'bypass' repetitive blocks of navigation and content via keyboard commands, skip links, and WAI-ARIA regions."
                </Markup.Emphasis>
            </p>
