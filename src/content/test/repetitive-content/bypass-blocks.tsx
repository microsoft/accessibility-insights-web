...
export const infoAndExamples = create(({ Markup, Link }) => <>
    ...
    <ul>
        <li>Provide a link for bypassing repeated content (preferred, as it helps all keyboard users):
            <ul>
                <li> <Markup.Links><Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G1">
                        Add a 'skip link' at the top of the page that navigates directly to the main content</Markup.HyperLink></Markup.Links>
                </li>
        ...
        <li>Group blocks of content so they can be bypassed (acceptable, but it helps only users of assistive technology):
            <ul>
                <li><Markup.Links><Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/aria/ARIA11">
                    Use ARIA landmarks to identify regions of a page</Markup.HyperLink></Markup.Links>
                </li>
                <li><Markup.Links><Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/html/H69">
                    Provide headings at the beginning of each section of content</Markup.HyperLink></Markup.Links>
                </li>
                <li><Markup.Links><Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/html/H70">
                    Use frame elements to group blocks of repeated content</Markup.HyperLink></Markup.Links>
                </li>
                <li><Markup.Links><Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/client-side-script/SCR28">
                        Contain repeated content in a collapsible menu</Markup.HyperLink></Markup.Links>
                </li>
            </ul>
        </li>
    </ul>
    ...
    <Markup.PassFail
        failText={
            <p>This page has no keyboard-accessible method for bypassing repetitive content.</p>
        }
        failExample={
           `<body>
                ...
