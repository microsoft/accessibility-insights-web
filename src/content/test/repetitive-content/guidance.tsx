...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            ...
            page's primary content. Content that appears repeatedly within a website or web app must be ordered and identified consistently
            to allow users to locate specific information efficiently.
        </p>
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Provide at least one method for keyboard users to navigate directly to the page’s main content. (<Link.WCAG_2_4_1 />)
                </h3>
                <ul>
                    <li>
                        Acceptable methods include{' '}
                        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/general/G1">skip links</Markup.HyperLink>,{' '}
                        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/aria/ARIA11">landmarks</Markup.HyperLink>, and
                        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/html/H69">headings</Markup.HyperLink>.
                    </li>
                    <li>
                        Skip links are a best practice, as they're available to all keyboard users, even if they don't use any assistive
                        technology.{' '}
                    </li>
                </ul>
                <h3>
                    Make sure navigational links that appear on multiple pages are ordered consistently. (<Link.WCAG_3_2_3 />)
                </h3>
                <ul>
                    <li>It’s ok if non-repeated (page-specific) links are inserted between repeated (site-wide) links.</li>
                </ul>
                <h3>
                    Make sure functional components that appear on multiple pages are identified consistently. (<Link.WCAG_3_2_4 />)
                </h3>
                <ul>
