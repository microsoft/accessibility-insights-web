...
export const infoAndExamples = createWithTitle(
    {
        pageTitle: 'Consistent identification',
    },
    ({ Markup }) => (
        <>
            ...
            <p>
                When components with the same function are identified consistently across the pages of a website or web app, users can find
                and recognize them more easily. For example, a user who wants to update certain sections of an online form will find the
                task easier if the site consistently provides an 'Edit' button for each section. Consistent use of labels and icons are
                helpful for everyone, especially people who have cognitive or reading disabilities.
            </p>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        A web app has multiple pages. On every page, there's a link that navigates to the user's profile. On some pages,
                        it's an image link showing the user's avatar, and its text alternative says, "User profile." On other pages, it's a
