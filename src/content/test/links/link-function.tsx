        ...
        <>
            ...
            <ul>
                <li>
                    ...
                    <Markup.HyperLink href="https://www.w3.org/TR/wai-aria-practices-1.1/#button">button</Markup.HyperLink> (standard or
                    toggle) or{' '}
                    <Markup.HyperLink href="https://www.w3.org/TR/wai-aria-practices-1.1/#menubutton">menu button</Markup.HyperLink> needs{' '}
            ...
            <Markup.PassFail
                failText={
                    <p>
                        An <Markup.Code>{'<a>'}</Markup.Code> element is programmed to serve as a button, and it does not have a button
                        widget role.
                    </p>
                }
