...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            ...
            users can examine the surrounding context for clues about the link's purpose. Assistive technologies similarly help non-sighted
            users by reporting the link's programmatically related context.
        </p>
        ...
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    {' '}
                    If an anchor element functions as a button, give it the appropriate ARIA widget role. (<Link.WCAG_4_1_2 />)
                </h3>
                <ul>
                    <li>
                        Good: Add <Markup.Code>role="button"</Markup.Code> to the anchor element.
                    </li>
                    <li>
                        Better: Use a <Markup.Code>{`<button>`}</Markup.Code> element instead of an <Markup.Code>{`<a>`}</Markup.Code>{' '}
                        element. (As a rule, it's better to use native semantics than to modify them using ARIA roles.)
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                If a link's destination is a document or web application, the name of the document or application is
                                sufficient.
                            </li>
                            <li>
                                Links with different destinations should have different descriptions; links with the same destination should
