...
export const infoAndExamples = create(({ Markup, Link }) => <>
    ...
    <p>
        Understanding a link's purpose helps users decide whether they want to follow it. When the link text alone is unclear,
        sighted users can examine the surrounding context for clues about the link's purpose. Assistive technologies can similarly
        help non-sighted users by reporting the link's programmatically related context.
    </p>
    ...
    <ul>
        ...
        <li>Links with different destinations should have different descriptions; links with the same destination should have the
            same description.</li>
    ...
    <p>
        <Markup.Emphasis>
            “I utilize a screen reader and keyboard to enjoy content and operate software. For every link, provide unique text so I
            know what will happen if I click the link. For example, “Shop Devices”, “Shop Software”, “Shop Games”. If you cannot do
            this, then use ARIA-label to identify each link so assistive technology can help me know what will happen when I click
            the link.”
        </Markup.Emphasis>
    </p>
    ...
    <Markup.PassFail
        failText={
            <p>In an online bookstore, each book has a title, a one-paragraph description, and a "Read more…" link. Because each link
                is in a separate paragraph, all the links have identical programmatically related context.</p>
        }
        failExample={
        ...
        passText={
            <p>The unique purpose of each link is made clear by adding the name of the book to the link text.</p>
        }
        passExample={
            `<h2>Slaughterhouse-five</h2>
            <p>Kurt Vonnegut's absurdist classic introduces us to Billy Pilgrim, a man who becomes "unstuck in time" after he is ` +
    ...
    <Markup.Links>
        ...
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/html/H79">
            Identifying the purpose of a link in a data table using the link text combined with its enclosing table cell and
            associated table header cells
        </Markup.HyperLink>
        <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/html/H81">
            Identifying the purpose of a link in a nested list using link text combined with the parent list item under which
            the list is nested
        </Markup.HyperLink>
    </Markup.Links>
