        ...
        <>
            ...
            <p>
                <Markup.Emphasis>
                    ...
                    know what will happen if I click the link. For example, 'Shop Devices', 'Shop Software', 'Shop Games'."
                </Markup.Emphasis>
            </p>
            ...
            <ul>
                ...
                <li>
                    Links with different destinations should have different descriptions; links with the same destination should have the
                    same description.
                </li>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        In an online bookstore, each book has a title, a one-paragraph description, and a "Read more…" link. Because each
                        link is in a separate paragraph, all the links have identical programmatically related context.
                    </p>
                }
                failExample={
            ...
            <Markup.Links>
                ...
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/html/H81">
                    Identifying the purpose of a link in a nested list using link text combined with the parent list item under which the
                    list is nested
                </Markup.HyperLink>
            </Markup.Links>
            ...
            <Markup.Links>
                ...
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F89">
                    Failure of Success Criteria 2.4.4, 2.4.9 and 4.1.2 due to not providing an accessible name for an image which is the
                    only content in a link
                </Markup.HyperLink>
            </Markup.Links>
