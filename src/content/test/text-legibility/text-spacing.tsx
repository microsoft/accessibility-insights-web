...
export const infoAndExamples = create(({ Markup }) => (
    <>
        <h1>Text spacing</h1>
        <p>
            Users must be able to adjust text spacing with no loss of content or
            functionality.
        </p>

        <h2>Why it matters</h2>
        <p>
            Increased spacing between lines, words, and/or letters can help
            people with low vision, dyslexia, and other cognitive disabilities.
        </p>

        <h2>How to fix</h2>
        <p>
            Ensure that text fits within its container without being cut off or
            overlapping other text when the{' '}
        ...
        <ul>
            <li>
                The container resizes automatically when text spacing is
                modified.
            </li>
        ...
        <Markup.PassFail
            failText={
                <p>
                    The height of a paragraph is fixed at 50px. Text in the
                    paragraph is clipped when line spacing is increased by the
                    user.
                </p>
            }
            failExample={`
            ...
            passText={
                <p>
                    The height of the paragraph adjusts automatically when line
