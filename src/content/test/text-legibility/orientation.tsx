...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <p>
                Some people with dexterity impairments prefer to use a device mounted in a fixed orientation. Some people with low vision
                prefer to view content in landscape orientation because it allows a larger text size. Not locking the content orientation
                allows it to match the device orientation.
            </p>
