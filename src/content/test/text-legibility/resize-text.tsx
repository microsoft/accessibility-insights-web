...
export const infoAndExamples = create(({ Markup, Link }) => (
    <>
        <h1>Resize text</h1>
        <p>
            Users must be able to resize text, without using assistive
            technology, up to 200% with no loss of content or functionality.
        </p>

        <h2>Why it matters</h2>
        <p>
            Most people find it easier to read text when it is sufficiently
            large. People with mild visual disabilities, low vision, or limited
            color perception are likely to find text unreadable when text is too
            small.
        </p>
        <p>
        ...
        <p>
            <Markup.Emphasis>
                "I wear bifocals and scratched my glasses, so I am having a hard
                time reading small type. Provide me a way to increase the text
                size by 200% without breaking the layout and functionality of
        ...
        <ol>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        Better: Is large enough to display all text at 200%, or
                    </li>
                    <li>
                        Best: Scales to display the enlarged text without
                        scrolling
                    </li>
                </ul>
            </li>
        ...
        <Markup.PassFail
            failText={
                <p>
                    This text won't resize because its font size is defined
                    using viewport units. Its container also has a fixed size
                </p>
            }
            failExample={`<html>
            <head>
