...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                <Markup.Emphasis>
                    "I wear bifocals and scratched my glasses, so I am having a hard time reading small type. Provide me a way to increase
                    the text size by 200% without breaking the layout and functionality of the content or interface."
                </Markup.Emphasis>
            </p>
            <h2>How to fix</h2>
            <ol>
            ...
            <Markup.Links>
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F69">
                    Failure of Success Criterion 1.4.4 when resizing visually rendered text up to 200 percent causes the text, image or
                    controls to be clipped, truncated or obscured
                </Markup.HyperLink>
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/failures/F80">
                    Failure of Success Criterion 1.4.4 when text-based form controls do not resize when visually rendered text is resized up
                    to 200%
                </Markup.HyperLink>
            ...
            <Markup.Links>
                ...
                <Markup.HyperLink href="https://www.w3.org/WAI/WCAG21/Techniques/css/C20">
                    Using relative measurements to set column widths so that lines can average 80 characters or less when the browser is
                    resized
                </Markup.HyperLink>
