...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            Most people find it easier to read text when it is sufficiently large and has a sufficiently high contrast against its
            background. People with mild visual disabilities, low vision, or limited color perception are especially likely to find text
