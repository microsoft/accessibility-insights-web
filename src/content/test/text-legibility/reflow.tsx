...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup }) => (
        <>
            ...
            <h2>How to fix </h2>
            <p>
                Use responsive web design to ensure page content reflows to fit within the window whenever the viewport narrows or the text
                size changes.
            </p>
            <ul>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        ...
                        panel. When viewed on a handheld device, the user must scroll both horizontally and vertically to see both the tabs
                        and the tab panel.
                    </p>
                }
                passText={
                    <p>
                        The tab control is redesigned so the tab panel moves below the tabs as needed when the viewport is narrowed or the
                        text size is increased. The user never needs to scroll horizontally to see the content.
                    </p>
                }
            />
