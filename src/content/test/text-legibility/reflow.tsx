    ...
    <>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    <li>the script is read horizontally (left-to-right or right-to-left), text should scroll vertically.</li>
                    <li>the script is read vertically (top-to-bottom), text should scroll horizontally.</li>
                </ul>
            </li>
        </ul>
        <h2>Example</h2>
