...
export const infoAndExamples = create(({ Markup }) => <>
    ...
    <p>
        ...
        People with mild visual disabilities, low vision,
        or limited color perception are likely to find text unreadable when contrast is too low.
    </p>
    <p>
    ...
    <Markup.PassFail
        failText={
            <p>White text displayed over a background photo has insufficient contrast in some areas.</p>
        }
        failExample={
            `<style>
            .container {
