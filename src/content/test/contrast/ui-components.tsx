...
export const infoAndExamples = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            ...
            UI Components must have sufficient contrast.
        </p>

        <h2>Why it matters</h2>
        <p>
            Most people find it easier to see and use UI Components when they
            have sufficient contrast against the background. People with low
            vision, limited color perception, or <Link.Presbyopia /> are
            especially likely to struggle with controls when contrast is too
            low.
        </p>

        <h2>How to fix</h2>
        <p>
            Make sure any visual information that helps users detect and operate
            a control has a contrast ratio ≥ 3:1. Such visual information
            includes:
        </p>
        <ul>
            <li>
                Any visual boundary that indicates the component's clickable
                area
            </li>
        ...
        <Markup.PassFail
            failText={
                <p>
                    A button with a light gray boundary (#cccccc) is displayed
                    on a white background (#ffffff). The boundary and background
                    have an insufficient contrast of 1.605:1.
                </p>
            }
            passText={
                <p>
                    The button has a medium gray boundary (#888888). The button
                    and white background have a sufficient contrast of 3.544:1.
                </p>
            }
        />
