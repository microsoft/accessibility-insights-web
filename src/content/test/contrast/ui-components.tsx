...
export const infoAndExamples = createWithTitle(
    ...
    ({ Markup, Link }) => (
        <>
            ...
            <p>
                Most people find it easier to see and use UI Components when they have sufficient contrast against the background. People
                with low vision, limited color perception, or <Link.Presbyopia /> are especially likely to struggle with controls when
                contrast is too low.
            </p>
            <h2>How to fix</h2>
            <p>
            ...
            <Markup.PassFail
                failText={
                    <p>
                        A button with a light gray boundary (#cccccc) is displayed on a white background (#ffffff). The boundary and
                        background have an insufficient contrast of 1.605:1.
                    </p>
                }
                passText={
                    <p>
                        The button has a medium gray boundary (#888888). The button and white background have a sufficient contrast of
                        3.544:1.
                    </p>
                }
            />
