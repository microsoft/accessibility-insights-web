...
export const guidance = create(({ Markup, Link }) => (
    <>
        ...
        <p>
            Higher contrast makes it easier to read text and graphics,
            especially for people with low vision, limited color perception, or{' '}
            <Link.Presbyopia />.
        </p>
        ...
        <Markup.Columns>
            <Markup.Do>
                <h3>
                    Provide sufficient contrast for visual information that
                    helps users detect and operate active controls. (
                    <Link.WCAG_1_4_11 />)
                </h3>
                <ul>
                    <li>
                        Any visual boundary that indicates the component's
                        clickable area must have a contrast ratio ≥ 3:1.
                    </li>
                    <li>
                        Any visual effect that indicates the component's state
                        must have a contrast ratio ≥ 3:1.
                    </li>
                </ul>
                <h3>
                ...
                <ul>
                    <li>
                        Elements in a graphic that communicate meaning must have
                        a contrast ratio ≥ 3:1.
                    </li>
                </ul>
            </Markup.Do>
            <Markup.Dont>
                <h3>
                    Don't style controls in a way that interferes with their
                    visual focus indicator. (<Link.WCAG_1_4_11 />)
                </h3>
                <ul>
                    <li>
                        Don't use CSS styling to turn off the default focus
                        indicator.
                    </li>
                    <li>
                        Don't style a control's borders in a way looks like a
                        focus indicator.
                    </li>
                    <li>
                        Don't style a control's borders in a way that occludes
                        the focus indicator.
                    </li>
                </ul>
            </Markup.Dont>
        ...
        <h2>Learn more</h2>
        <h3>
            Sufficient contrast for controls' boundaries, states, and state
            changes
        </h3>
