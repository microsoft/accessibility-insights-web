...
export const link = {
    ...
    BingoBakery: linkTo(
        'Bingo Bakery Video',
        'https://go.microsoft.com/fwlink/?linkid=2080372',
    ),
    IdentifyHeadings: linkTo(
    ...
    Keyboard: linkTo(
        ...
        'https://aka.ms/webaim/keyboard-accessibility',
    ),
