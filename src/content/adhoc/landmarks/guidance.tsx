...
export const guidance = create(({ Markup, Link }) => (
    <React.Fragment>
        ...
        <p>
            ...
            <Markup.Term>Landmarks</Markup.Term> visualization highlights landmarks directly on the page. It does not highlight landmarks
            that are unavailable to assistive technology because they have the <Markup.Term>hidden</Markup.Term> attribute.
        </p>
        ...
        <Markup.Columns>
            <Markup.Do>
                ...
                <ul>
                    <li>
                        Turn on the <Markup.Term>Landmarks</Markup.Term> visualization, then zoom out so you can see the entire page. If you
                ...
                <Markup.Table>
                    <li>
                        ...
                        An area at the beginning of the page containing site-oriented content
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        An area of the page containing a collection of form-related elements
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        An area of the page containing information that is sufficiently important that users should be able to navigate to
                        it
                    </li>
                    <li>
                ...
                <h3>
                    If you use the same landmark role more than once in a page, give each instance an accessible label that makes it unique.
                </h3>

                <ul>
                    <li>
                        In the visualization, accessible labels (<Markup.Term>aria-label</Markup.Term> or{' '}
            ...
            <Markup.Dont>
                ...
                <ul>
                    <li>
                        In the visualization, the label displayed for each landmark approximates how most screen readers would announce it.
                    </li>
                </ul>
            </Markup.Dont>
        </Markup.Columns>
