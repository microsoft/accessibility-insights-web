    ...
    <>
        ...
        <Markup.Columns>
            <Markup.Do>
                ...
                <ul>
                    <li>
                        Input focus is commonly indicated by a <Markup.Term>solid or dotted border</Markup.Term> surrounding the element,
                        but other visible changes are acceptable.
                    </li>
                </ul>
                ...
                <ul>
                    <li>
                        Users should be able <Markup.Term>tab to every interactive element</Markup.Term> on the page unless it is currently
                        disabled.
                    </li>
            ...
            <Markup.Dont>
                ...
                <ul>
                    <li>
                        If the default tab order isn't ideal, first try to fix the problem by{' '}
                        <Markup.Term>rearranging the content</Markup.Term> and/or <Markup.Term>changing the style sheet</Markup.Term>.
                    </li>
                </ul>
