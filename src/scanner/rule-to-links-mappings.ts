...
export const ruleToLinkConfiguration: DictionaryStringTo<HyperlinkDefinition[]> = {
    ...
    'landmark-main-is-top-level': [link.WCAG_1_3_1, link.WCAG_2_4_1, BestPractice],
    ...
    'landmark-banner-is-top-level': [link.WCAG_1_3_1, link.WCAG_2_4_1, BestPractice],
    'landmark-contentinfo-is-top-level': [link.WCAG_1_3_1, link.WCAG_2_4_1, BestPractice],
