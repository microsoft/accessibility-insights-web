...
export class StoreActionMessageCreatorImpl
    implements StoreActionMessageCreator {
    constructor(
        private readonly getStateMessages: string[],
        private readonly dispatcher: ActionMessageDispatcher,
    ) {}

    public getAllStates(): void {
        this.getStateMessages.forEach(message =>
