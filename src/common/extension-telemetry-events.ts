...
export const START_OVER_MEDIUM_PASS: string = 'startOverMediumPass';
export const CANCEL_START_OVER_MEDIUM_PASS: string = 'cancelStartOverMediumPass';
...
export const CONTINUE_PREVIOUS_MEDIUM_PASS: string = 'ContinuePreviousMediumPass';
export const LOAD_MEDIUM_PASS: string = 'loadMediumPass';
export const SAVE_MEDIUM_PASS: string = 'saveMediumPass';
...
export const CHANGE_MEDIUM_PASS_VISUALIZATION_STATUS: string = 'changeMediumPassVisualizationState';
export const CHANGE_MEDIUM_PASS_VISUALIZATION_STATUS_FOR_ALL: string =
    'changeMediumPassVisualizationStateForAll';
...
export const MEDIUM_PASS_SCAN_COMPLETED: string = 'MediumPassScanCompleted';
