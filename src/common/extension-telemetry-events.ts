...
export const START_OVER_MEDIUM_PASS: string = 'startOverQuickAssess';
export const CANCEL_START_OVER_MEDIUM_PASS: string = 'cancelStartOverQuickAssess';
...
export const CONTINUE_PREVIOUS_MEDIUM_PASS: string = 'ContinuePreviousQuickAssess';
export const LOAD_MEDIUM_PASS: string = 'loadQuickAssess';
export const SAVE_MEDIUM_PASS: string = 'saveQuickAssess';
...
export const CHANGE_MEDIUM_PASS_VISUALIZATION_STATUS: string =
    'changeQuickAssessVisualizationState';
export const CHANGE_MEDIUM_PASS_VISUALIZATION_STATUS_FOR_ALL: string =
...
export const MEDIUM_PASS_SCAN_COMPLETED: string = 'QuickAssessScanCompleted';
...
export const SET_SAVE_MEDIUM_PASS_DIALOG_STATE: string = 'setSaveQuickAssessDialogState';
