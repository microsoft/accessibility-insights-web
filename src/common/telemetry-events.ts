...
export const ISSUE_FILING_SETTINGS_DIALOG_OPEN: string = 'IssueFilingSettingsDialogOpen';
export const ISSUE_FILING_SETTINGS_DIALOG_CLOSE: string = 'IssueFilingSettingsDialogClose';
export const ISSUE_FILING_WINDOW_OPEN: string = 'IssueFilingWindowOpen';
