...
} from './privacy-statement-text';
import { TelemetryNotice, TelemetryNoticeDeps } from './telemetry-notice';

export type EnableTelemetrySettingDescriptionDeps = TelemetryNoticeDeps &
    PrivacyStatementTextDeps;
...
export const EnableTelemetrySettingDescription = NamedFC<
    EnableTelemetrySettingDescriptionProps
>('EnableTelemetrySettingDescription', props => (
    <>
