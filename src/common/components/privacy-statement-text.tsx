...
export const PrivacyStatementText = NamedFC<PrivacyStatementTextProps>(
...
export const PrivacyStatementPopupText = NamedFC<PrivacyStatementTextProps>(
    'PrivacyStatementPopupText',
    props => (
        <>
            You can change this choice anytime in settings.{' '}
            <PrivacyStatementText deps={props.deps}></PrivacyStatementText>
        </>
    ),
);
