...
export const ReportFooter = NamedFC<ReportFooterProps>(
    'ReportFooter',
    ({ environmentInfo }) => {
        const {
            extensionVersion,
        ...
        return (
            <div className="report-footer-container">
                <div className="report-footer" role="contentinfo">
                    ...
                    {`${toolName} ${extensionVersion} (Axe ${axeCoreVersion})`},
                    a tool that helps debug and find accessibility issues
                    earlier on {browserSpec}. Get more information & download
                    this tool at{' '}
                    <NewTabLink
