...
export const allRequirementOutcomeTypes: RequirementOutcomeType[] = [
    'pass',
    'incomplete',
    'fail',
];

export function outcomeTypeFromTestStatus(
...
export type RequirementOutcomeStats = {
    [OT in RequirementOutcomeType]: number;
};
