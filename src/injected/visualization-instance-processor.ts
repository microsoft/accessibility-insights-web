...
import { PartialTabOrderPropertyBag, ITabOrderPropertyBag } from './tab-order-property-bag';
...
export type PropertyBags = PartialTabOrderPropertyBag | ITabOrderPropertyBag;
...
export class VisualizationInstanceProcessor {
    ...
    public static addOrder: VisualizationInstanceProcessorCallback<PartialTabOrderPropertyBag, ITabOrderPropertyBag> = instances => {
