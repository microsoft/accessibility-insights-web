...
import { Analyzer, IAnalyzerConfiguration, IFocusAnalyzerConfiguration, RuleAnalyzerConfiguration } from './analyzer';
...
export class AnalyzerProvider {
    ...
    public createBaseAnalyzer(config: IAnalyzerConfiguration): Analyzer {
