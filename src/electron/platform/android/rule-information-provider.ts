...
import { UnifiedFormattedResolution, UnifiedResolution } from 'common/types/store-data/unified-data-interface';
...
export class RuleInformationProvider {
    ...
    constructor() {
        this.supportedRules = {
            ...
            ActiveViewName: new RuleInformation(
                ...
                () =>
                    this.buildUnifiedFormattedResolution(
    ...
    private getColorContrastUnifiedResolution = (ruleResultsData: RuleResultsData): UnifiedResolution => {
        ...
        return this.buildUnifiedFormattedResolution(
    ...
    private getTouchSizeUnifiedResolution = (ruleResultsData: RuleResultsData): UnifiedFormattedResolution => {
    ...
    private buildUnifiedFormattedResolution(unformattedText: string, codeStrings: string[] = null): UnifiedFormattedResolution {
