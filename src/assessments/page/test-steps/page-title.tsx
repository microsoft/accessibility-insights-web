...
const pageTitleHowToTest: JSX.Element = (
    <div>
        <ol>
            <li>Consider the title of the target page, displayed in the <Term>Instances</Term> list below.</li>
            <li>Verify that the page's title describes its topic or purpose:
                <ol>
            ...
            <li>Record your results:
                <ol>
                    <li>Select <Term>Fail</Term> if the page title does not meet the requirement.</li>
                    <li>Otherwise, select <Term>Pass</Term>.</li>
                </ol>
            </li>
        </ol>
    </div>
