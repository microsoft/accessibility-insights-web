...
const bypassBlocksDescription: JSX.Element = (
    <span>
        A page must provide a keyboard-accessible method to bypass repetitive
        content.
    </span>
);
        ...
        <ol>
            <li>
                ...
                <ol>
                    ...
                    <li>
                        Any blocks of content that (1){' '}
                        <Markup.Emphasis>precede</Markup.Emphasis> the primary
                        content and (2) appear on multiple pages, such as
                        banners, navigation links, and advertising frames.
                    </li>
                </ol>
            </li>
            <li>Refresh the page to ensure that it's in its default state.</li>
            <li>
                Use the <Markup.Term>Tab</Markup.Term> key to navigate toward
                the primary content. As you navigate, look for a bypass
                mechanism (typically a{' '}
                <NewTabLink href="https://dequeuniversity.com/rules/axe/3.1/skip-link">
                    skip link
                </NewTabLink>
                ). The mechanism might not become visible until it receives
                focus.
            </li>
            <li>
                If a bypass mechanism{' '}
                <Markup.Emphasis>does not</Markup.Emphasis> exist, select{' '}
                <Markup.Term>Fail</Markup.Term>, then add the failure instance.
            </li>
            <li>
                If a bypass mechanism <Markup.Emphasis>does</Markup.Emphasis>{' '}
                exist, activate it.
            </li>
            <li>
                Verify that focus shifts past any repetitive content to the
