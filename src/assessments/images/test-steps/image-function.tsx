...
const howToTest: JSX.Element = (
    <div>
        ...
        <br />
        <Markup.Emphasis>
            Notes: (1) If an image has no code to identify it as meaningful or decorative,
            it will fail an automated check. (2) Assistive technologies will ignore any image
            coded as decorative, even if it has an accessible name.
        </Markup.Emphasis>
        <ol>
            <li>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        it could be removed from the page with <Markup.Emphasis>no</Markup.Emphasis> impact on meaning or function.
                    </li>
                </ol>
            </li>
