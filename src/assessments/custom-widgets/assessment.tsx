...
const gettingStarted: JSX.Element = (
    <React.Fragment>
        <p>
            A <Markup.Emphasis>widget</Markup.Emphasis> is an interactive
            interface component, such as a link, button, or combo box.
        </p>
        <p>
            A <Markup.Emphasis>custom widget</Markup.Emphasis> is an interactive
            interface component other than a link or native HTML element. Custom
            widgets can be simple (e.g., a link or a button) or complex (e.g., a
