...
const keyboardInteractionHowToTest: JSX.Element = (
    <div>
        ...
        <ol>
            <li>
                For each custom widget, open the spec for the design pattern that best describes the widget's function.
                (If the widget has the correct role, the design pattern link in the <Markup.Term>Instances</Markup.Term> list below will open the correct spec.)
            </li>
            <li>
                Familiarize yourself with the "Keyboard Interaction" section of the spec.
            </li>
            <li>
                Interact with the widget to verify that it supports the keyboard interactions specified by its design pattern.
            </li>
