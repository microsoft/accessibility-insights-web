...
const LinkPurposeDescription: JSX.Element = (
    <span>
        The purpose of a link must be described by its link text alone, or by
        the link text together with preceding page context.
    </span>
);
...
const LinkPurposeHowToTest: JSX.Element = (
    <div>
        ...
        <ol>
            <li>
                In the <Markup.Term>Instances</Markup.Term> list below, examine
                each link to verify that its accessible name describes its
                purpose.
                <ol>
                    <li>
                        If a link navigates to a document or web page, the name
                        of the document or page is sufficient.
                    </li>
                    <li>
                    ...
                    <li>
                        Links with the same destination should have the same
                        link text.
                    </li>
                </ol>
            </li>
            <li>
                If a link's purpose is clear from its accessible name, mark it
                as <Markup.Term>Pass</Markup.Term>.
            </li>
            <li>
                If a link's purpose is <Markup.Emphasis>not</Markup.Emphasis>{' '}
                clear from its accessible name, examine the link in the context
                of the target page to verify that its purpose is described by
                the link together with its preceding page context, which
                includes:
                <ol>
                    <li>
                        Text in the same sentence, paragraph, list item, or
                        table cell as the link
                    </li>
                    <li>Text in a parent list item</li>
                    <li>
                        Text in the table header cell that's associated with
