...
const description: JSX.Element = (
    <span>
        The content in an HTML layout table must make sense when the table is
        linearized.
    </span>
);
    ...
    <div>
        ...
        <ol>
            <li>
                ...
                <Markup.Term>Outline > Outline Tables</Markup.Term>) to identify
                any <Markup.Tag tagName="table" /> elements in the target page.
            </li>
            <li>
            ...
            <li>
                If you find a layout table, use the Web Developer browser
                extension (
                <Markup.Term>Miscellaneous > Linearize page</Markup.Term>) to
                show the page in DOM order.
            </li>
            <li>
                Verify that content in layout tables still has the correct
                reading order when the page is linearized.
            </li>
