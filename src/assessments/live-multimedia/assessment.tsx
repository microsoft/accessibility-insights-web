...
const gettingStartedText: JSX.Element = (
    <React.Fragment>
        <p>
            Captions help people who are deaf or have a hearing loss watch live
            (real-time) presentations by providing an equivalent alternative for
            the <Markup.Emphasis>audio</Markup.Emphasis> in multimedia content.
