...
const description: JSX.Element = <span>Users must be able to turn off or remap character key shortcuts.</span>;

const howToTest: JSX.Element = (
    <div>
        <ol>
            <li>
                Examine the target page to identify any keyboard shortcuts that can be activated using only printable keys, such as letters,
