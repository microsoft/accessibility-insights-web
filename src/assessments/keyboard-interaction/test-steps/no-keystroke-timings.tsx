...
const howToTest: JSX.Element = (
    <div>
        <ol>
            <li>
                Use the keyboard to perform all functions that are available
                using a mouse.
            </li>
            <li>
                Verify that individual keystrokes do not require specific
                timings, such as requiring users to:
                <ol>
                    <li>
                        Repeatedly press a key within a short period of time
                    </li>
                    <li>
                        Enter a series of keystrokes within a short period of
                        time
                    </li>
