...
const howToTest: JSX.Element = (
    <div>
        <ol>
            <li>
                Use standard keyboard commands (unmodified Tab and arrow keys) to navigate through all the interactive interface components in the target page.
            </li>
            <li>
                If you can't navigate away from a component using standard keyboard commands:
                <ol>
                    <li>
                       Examine the component's accessible name and accessible description to determine whether they describe an alternative keyboard command.
                </li>
                    <li>
            ...
            <li>
                ...
                <ol>
                    <li>
                        Standard keyboard commands, or
                    </li>
                    <li>
                       An alternative keyboard command that's described to users.
                    </li>
                </ol>
            </li>
...
export const NoKeyboardTraps: TestStep = {
