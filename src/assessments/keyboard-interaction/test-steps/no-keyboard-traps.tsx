...
const description: JSX.Element = (
    <span>
        Users must be able to <Markup.Emphasis>navigate away</Markup.Emphasis> from all components
        using a keyboard.
    </span>
);
...
const howToTest: JSX.Element = (
    <div>
        <ol>
            <li>
                Use standard keyboard commands (unmodified Tab and arrow keys) to navigate through
                all the interactive interface components in the target page.
            </li>
            <li>
