...
const textDirectionDescription: JSX.Element = (
    <span>
        If a page or a passage uses a script that is read right-to-left, it must
        have the correct text direction.
    </span>
);
...
const textDirectionHowToTest: JSX.Element = (
    <div>
        <ol>
            ...
            <li>
                If the page or a passage <Markup.Emphasis>does</Markup.Emphasis>{' '}
                use a right-to-left script, examine the containing element's
                HTML to verify that it has the correct direction attribute (
                <Markup.Term>dir="rtl"</Markup.Term>).
            </li>
