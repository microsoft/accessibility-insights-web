...
const textDirectionDescription: JSX.Element = <span>If a page or a passage uses a script that is read right-to-left, it must have the correct text direction.</span>;
