...
const description: JSX.Element = (
    <span>Functions must be operable without requiring multipoint or path-based gestures.</span>
);
...
const howToTest: JSX.Element = (
    <div>
        <ol>
            <li>
                Examine the target page to identify any functions that can be operated using either
                of the following:
                <ol>
                    <li>
                        <Markup.Term>Multipoint gestures</Markup.Term>, such as a two-fingered pinch
                        zoom or a three-fingered tap.
                    </li>
                    <li>
            ...
            <li>
                Verify that the function is <Markup.Emphasis>also</Markup.Emphasis> operable using a
                single-point, non-path-based gesture, such as a double-click or a long press.
                <br />
