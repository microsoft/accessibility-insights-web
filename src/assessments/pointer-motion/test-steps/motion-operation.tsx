...
const description: JSX.Element = (
    <span>
        If a function can be operated through motion, it must also be operable
    ...
    <div>
        <ol>
            <li>
                ...
                operated by device motion (such as shaking) or user motion (such
                as walking).
            </li>
            <li>
                ...
                <ol>
                    <li>
                        The function is also operable through user interface
                        components (such as a toggle button).{' '}
                    </li>
                    <li>Motion operation can be disabled by the user.</li>
                </ol>
                Exception: This requirement does not apply if motion activation
                is{' '}
