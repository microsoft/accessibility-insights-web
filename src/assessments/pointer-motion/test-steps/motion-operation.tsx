...
const description: JSX.Element = (
    <span>
        If a function can be operated through motion, it must also be operable through user
...
const howToTest: JSX.Element = (
    <div>
        <ol>
            <li>
                Examine the target page to identify any functions that can be operated by device
                motion (such as shaking) or user motion (such as walking).
            </li>
            <li>
                Verify that both of the following are true:
                <ol>
                    <li>
                        The function is also operable through user interface components (such as a
                        toggle button).{' '}
                    </li>
                ...
                to the underlying function, such as tracking a user’s steps.
            </li>
