...
const contrastDescription: JSX.Element = (
    <span>Text elements must have sufficient contrast.</span>
);

const contrastHowToTest: JSX.Element = (
    <div>
        <p>
            For this requirement, {productName} highlights instances of text
            where the contrast ratio can't be determined, typically because the
            background color is not uniform. You must manually verify the
            contrast for these instances.
        </p>
        <TestAutomaticallyPassedNotice />
        <ol>
            <li>
                Examine each instance in the target page to identify an area
                where the text and background are most likely to have a low
                contrast ratio (e.g., white text on a light gray background).
            </li>
            <li>
                Use <WindowsContrastCheckerAppLink /> to test the contrast at
                that area. (If you are testing on a Mac, you can use the{' '}
                <MacContrastCheckerAppLink />
                .)
            </li>
            <li>
                ...
                <ol>
                    <li>
                        Regular text must have a ratio{' '}
                        <Markup.GreaterThanOrEqualTo /> 4.5
                    </li>
                    <li>
        ...
        provider.createRuleAnalyzer(
            AnalyzerConfigurationFactory.forScanner({
                ...
                resultProcessor: (scanner: ScannerUtils) =>
                    scanner.getIncompleteInstances,
            }),
        ),
