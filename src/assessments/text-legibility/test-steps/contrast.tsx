...
const contrastHowToTest: JSX.Element = (
    <div>
        For this requirement, {productName} highlights instances of text where the contrast ratio can't be determined,
        typically because the background color is not uniform. You must manually verify the contrast for these instances.
        <ol>
            <li>
                Examine each instance in the target page to identify an area where the text and background are most likely
                to have a low contrast ratio (e.g., white text on a light gray background).
            </li>
            <li>
                Use <NewTabLink href="https://aka.ms/k4d">{windowsPlatformTitle}</NewTabLink> to test the contrast at that area.
                (If you are testing on a Mac, you can use the
