...
const colorSensoryGettingStartedText: JSX.Element = (
    <React.Fragment>
        <p>
            ...
            are the only means used to convey information, people with
            disabilities do not have access to the same information that others
            have. Meaning communicated through sensory characteristics must{' '}
