...
const auditoryCuesHowToTest: JSX.Element = (
    <div>
        <ol>
            <li>
                Interact with the target page to identify any instances where
                the system provides auditory cues, such as:
                <ol>
                    <li>
            ...
            <li>
                For each instance, verify that the system{' '}
                <Markup.Emphasis>also</Markup.Emphasis> provides a visible cue.
            </li>
