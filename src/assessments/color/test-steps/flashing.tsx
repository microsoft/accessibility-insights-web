    ...
    <React.Fragment>
        <ol>
            ...
            <li>If you find such content, determine whether it flashes faster than three times per second.
                <ol>
                    <li>Use this <NewTabLink aria-label="Read more about flashing test example" href="../../assessments/color/test-steps/flashing-text-example.html">link</NewTabLink> to see an example of content that flashes three times per second. (The example will open in a new browser window.)</li>
                </ol>
            </li>
             <li>
                ...
                <ol>
                    <li>
                        The total flashing area is smaller than 21,824 pixels (in any shape).
                    </li>
                    <li>
                        The relative luminance between the brightest and darkest portions of the flash is less than 10% and the flash does not include any saturated red.
                    </li>
                </ol>
            </li>
