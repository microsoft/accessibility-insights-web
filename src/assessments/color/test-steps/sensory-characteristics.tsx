...
const sensoryCharacteristicsDescription: JSX.Element = (
    <span>
        Instructions must not rely solely on color or other sensory
        characteristics.
    </span>
);
...
const sensoryCharacteristicsHowToTest: JSX.Element = (
    <div>
        <ol>
            <li>
                Examine the target page to identify any instances where
                instructions refer to an element's sensory characteristics, such
                as:
                <ol>
                    <li>Color</li>
                    <li>Shape</li>
            ...
            <li>
                For each instance, verify that the instructions also include
                additional information sufficient to locate and identify the
                element without knowing its sensory characteristics. (For
