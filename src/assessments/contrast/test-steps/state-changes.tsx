...
const description: JSX.Element = (
    <span>
        Any visual effect that indicates a component's state must have
        sufficient contrast.
    </span>
);
...
const howToTest: JSX.Element = (
    <div>
        <p>
            The visual helper for this requirement highlights links, native
            widgets, and custom widgets in the target page.
        </p>
        <ol>
            <li>
                In the target page, examine each highlighted element to
                determine whether it supports any of the following states:
                <ol>
                    <li>Focused</li>
                    <li>Mouseover</li>
                    <li>Selected</li>
            ...
            <li>
                In each supported state, use <WindowsContrastCheckerAppLink />{' '}
                (or the <MacContrastCheckerAppLink /> if you are testing on a
                Mac) to verify that the following visual presentations (if
                implemented) have a contrast ratio of at least 3:1 against the
                adjacent background:
                <ol>
                    <li>
                    ...
                    <li>
                        Any visual effect that indicates the component's current
                        state.
                    </li>
                </ol>
                Note: If an element has redundant state indicators (such as a
                unique background color <Markup.Emphasis>and</Markup.Emphasis> a
                unique text style), only one indicator is required to have
                sufficient contrast.
                <br />
                Exception: A lower contrast ratio is allowed if either of the
                following is true:
                <ol>
                    <li>The component is inactive/disabled.</li>
                    <li>
                        The component's appearance is determined solely by the
                        browser.
                    </li>
                </ol>
            </li>
