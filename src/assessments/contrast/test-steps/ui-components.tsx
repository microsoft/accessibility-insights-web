...
const description: JSX.Element = (
    <span>
        ...
        interface components must have sufficient contrast.
    </span>
);
...
const howToTest: JSX.Element = (
    <div>
        ...
        <ol>
            <li>
                In the target page, examine each highlighted element in its
                normal state (not disabled or selected, no mouseover or input
                focus).
            </li>
            <li>
                Use <WindowsContrastCheckerAppLink /> (or if you are testing on
                a Mac, the <MacContrastCheckerAppLink />) to verify that the
                following visual presentations (if implemented) have a contrast
                ...
                <ol>
                    ...
                    <li>
                        Any visual effect that indicates the component is in its
                        normal state
                    </li>
                </ol>
