...
const description: JSX.Element = (
    <span>Graphics must have sufficient contrast.</span>
);

const howToTest: JSX.Element = (
    <div>
        <p>
            The visual helper for this requirement highlights images coded as
            meaningful.
        </p>
        <ol>
            <li>
                In the target page, examine each highlighted image to identify
            ...
            <li>
                For each graphic, identify the parts that are necessary for the
                graphic to be understood. (This is subjective.)
            </li>
            <li>
                <p>
                    Use <WindowsContrastCheckerAppLink /> to verify that each
                    necessary part has a contrast ratio of at least 3:1 against
                    the adjacent background. (If you are testing on a Mac, you
                    can use the <MacContrastCheckerAppLink />
                    .)
                </p>
                <p>
                    Exception: A lower contrast ratio is allowed for logos,
                    photos, and other cases where a specific visual presentation
                    is{' '}
