...
const noConflictDescription: JSX.Element = (
    <span>
        An audio description must not conflict with audible information in the
        sound track.
    </span>
);
...
const noConflictHowToTest: JSX.Element = (
    <div>
        <ol>
            ...
            <li>
                Verify that the audio description does not conflict with
                relevant information in the soundtrack. (Descriptive narration
