...
const captionsHowToTest: JSX.Element = (
    <div>
        <ol>
            <li>Examine the target page to identify any pre-recorded multimedia content (synchronized video and audio).</li>
            <ol>
                <li>
                    Ignore any multimedia content that is provided as an audio or video alternative to text and is clearly labeled as such.
                </li>
            </ol>
            <li>Enable captions, then play the multimedia content.</li>
            <li>Verify that the multimedia content has captions.</li>
            <li>If you find any multimedia content that doesn't have captions, select <Markup.Term>Fail</Markup.Term>, then add the failure instance.</li>
            <li>Verify that the captions provide an accurate and complete description of the audio content, including speaker identity, speech, and meaningful sounds.</li>
