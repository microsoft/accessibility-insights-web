...
const howToTest: JSX.Element = (
    <div>
        <p>
            The visual helper for this requirement highlights the page's main
            landmark.
        </p>
        <ol>
            <li>
                In the target page, examine the{' '}
                <Markup.CodeTerm>main</Markup.CodeTerm> landmark to verify that
                it contains all of the page's primary content.
            </li>
