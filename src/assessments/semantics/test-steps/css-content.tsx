...
const cssContentHowToTest: JSX.Element = (
    <div>
        <p>
            The visual helper for this requirement highlights content inserted
            in the page using CSS <Markup.Term>:before</Markup.Term> or{' '}
        ...
        <ol>
            <li>
                In the target page, examine each highlighted item to determine
                whether it is meaningful or decorative.
                <ul>
                    <li>
                        An element is{' '}
            ...
            <li>
                ...
                <ul>
                    <li>
                        Determine whether the information in inserted content is
                        ...
                        <ul>
                            ...
                            <li>
                                In the accessibility tree, examine the element
                                with inserted content and its ancestors.
                            </li>
                            <li>
                                Verify that any information conveyed by the
                                inserted content is shown in the accessibility
                                tree.
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        Determine whether the information in inserted content is
                        visible when CSS is turned off:
                        <ul>
                            <li>
                            ...
                            <li>
                                Verify that any information conveyed by the
                                inserted content is visible in the target page.
                            </li>
                        </ul>
                    </li>
                </ul>
...
const cssContentDescription: JSX.Element = (
    <span>
        ...
        <Markup.Term>:before</Markup.Term> or <Markup.Term>:after</Markup.Term>.
    </span>
);
...
export const CssContent: Requirement = {
    ...
    getDrawer: provider =>
        provider.createSingleTargetDrawer(
