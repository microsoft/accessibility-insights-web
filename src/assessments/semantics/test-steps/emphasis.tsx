...
const emphasisDescription: JSX.Element = (
    <span>
        Words and phrases that are visually emphasized must be contained within
        semantically correct containers.
    </span>
);
...
const emphasisHowToTest: JSX.Element = (
    <div>
        ...
        <ol>
            <li>
                Examine the target page to identify any visually emphasized
                words or phrases.
            </li>
            <li>
                Inspect the HTML for each emphasized word or phrase to verify
                that it's contained in an <Markup.Tag tagName="em" /> or{' '}
