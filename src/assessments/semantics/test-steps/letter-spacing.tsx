...
const letterSpacingHowToTest: JSX.Element = (
    <div>
        ...
        <ol>
            <li>
                Examine the target page to identify any words that appear to have increased spacing
                between letters.
            </li>
            <li>
                Inspect the HTML for each word with increased spacing to verify that it does not
                include any spacing characters. Spacing characters include spaces, tabs, line
