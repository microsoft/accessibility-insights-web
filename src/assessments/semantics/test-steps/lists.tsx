...
const listsHowToTest: JSX.Element = (
    <div>
        ...
        <ol>
            <li>
                Examine the target page to identify any content that appears to be a list. A list is a set of related items displayed
                consecutively. List items are usually, but not always, stacked vertically.
            </li>
            <li>
                Examine the HTML for each list to verify that it is contained within the semantically correct element:
                <ol>
                    <li>
                        An <Markup.Emphasis>unordered</Markup.Emphasis> list (plain or bulleted) must be contained within with a{' '}
