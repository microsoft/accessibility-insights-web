...
const description: JSX.Element = (
    <span>
        Activating a component that reveals hidden content must move input focus
        into the revealed content.
    </span>
);
    ...
    <div>
        <ol>
            <li>
                ...
                that reveal hidden content, such as menus, dialogs, expandable
                tree views, etc.
            </li>
            <li>Use the keyboard to activate each trigger component.</li>
            <li>
                Verify that focus is moved into the revealed content. (It is
                acceptable to <Markup.Term>Tab</Markup.Term> once or use an
