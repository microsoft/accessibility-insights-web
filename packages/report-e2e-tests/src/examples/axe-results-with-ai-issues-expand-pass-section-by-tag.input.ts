...
export const axeResultsWithAiIssuesExpandPassSectionByTag: AxeReportParameters = {
    description: 'Description for Axe Results With AI-detected Issues',
    scanContext: {
        pageTitle: 'Page Title for Axe Results With AI-detected Issues',
    },
    serviceName: 'Service Name for Axe Results With AI-detected Issues',
    results: {
        inapplicable: [
            {
        ...
        violations: [
            ...
            },
            {
                ...
                tags: ['cat.semantics', 'best-practice', 'ai-scan'],
            },
            {
