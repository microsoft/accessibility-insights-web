...
export const axeResultsWithUndefinedFeedbackURL: AxeReportParameters = {
    description: 'Description for Axe Results With Issues and undefined feedback URL',
    scanContext: {
        pageTitle: 'Page Title for Axe Results With Issues and undefined feedback URL',
    },
    serviceName: 'Service Name for Axe Results With Issues and undefined feedback URL',
