...
export const axeResultsWithAiIssuesFeedbackURL: AxeReportParameters = {
    description: 'Description for Axe Results With Issues and Feedback URL',
    scanContext: {
        pageTitle: 'Page Title for Axe Results With Issues and Feedback URL',
    },
    serviceName: 'Service Name for Axe Results With Issues and Feedback URL',
    feedbackURL: 'https://microsoft.com/mock-feedback-url/',
    results: {
        inapplicable: [
            {
