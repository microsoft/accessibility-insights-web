...
`mock-adb` itself is written in Rust for performance reasons; the Unified tests invoke it hundreds of times, and writing it in Node.js creates ~2s of overhead per call on some of the lower-end dev machines our team tests against.
